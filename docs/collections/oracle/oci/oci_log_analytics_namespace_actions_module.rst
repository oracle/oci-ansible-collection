...
.. _ansible_collections.oracle.oci.oci_log_analytics_namespace_actions_module:
...
oracle.oci.oci_log_analytics_namespace_actions -- Perform actions on a Namespace resource in Oracle Cloud Infrastructure
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_log_analytics_namespace_actions`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The action to perform on the Namespace.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                ...
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-namespace/compartment_id"></div>
                    <b>compartment_id</b>
                    <a class="ansibleOptionLink" href="#return-namespace/compartment_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-namespace/is_data_ever_ingested"></div>
                    <b>is_data_ever_ingested</b>
                    <a class="ansibleOptionLink" href="#return-namespace/is_data_ever_ingested" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">boolean</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-namespace/is_log_set_enabled"></div>
                    <b>is_log_set_enabled</b>
                    <a class="ansibleOptionLink" href="#return-namespace/is_log_set_enabled" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">boolean</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>This indicates if the log set feature is enabled for the tenancy</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">True</div>
                                    </td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-namespace/is_onboarded"></div>
                    <b>is_onboarded</b>
                    <a class="ansibleOptionLink" href="#return-namespace/is_onboarded" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">boolean</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-namespace/namespace_name"></div>
                    <b>namespace_name</b>
                    <a class="ansibleOptionLink" href="#return-namespace/namespace_name" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
