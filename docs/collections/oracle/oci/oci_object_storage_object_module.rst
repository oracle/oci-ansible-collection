...
.. _ansible_collections.oracle.oci.oci_object_storage_object_module:
...
- This resource has the following action operations in the :ref:`oci_object_actions <ansible_collections.oci_object_actions_module>` module: copy, reencrypt, rename, restore, update_object_storage_tier.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-cache_control"></div>
                    <b>cache_control</b>
                    <a class="ansibleOptionLink" href="#parameter-cache_control" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-content_language"></div>
                    <b>content_language</b>
                    <a class="ansibleOptionLink" href="#parameter-content_language" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-content_md5"></div>
                    <b>content_md5</b>
                    <a class="ansibleOptionLink" href="#parameter-content_md5" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-opc_meta"></div>
                    <b>opc_meta</b>
                    <a class="ansibleOptionLink" href="#parameter-opc_meta" title="Permalink to this option"></a>
                    <div style="font-size: small">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                            ...
                                            <div>Use <em>state=present</em> to update an existing an Object.</div>
                                            <div>Use <em>state=absent</em> to delete an Object.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
