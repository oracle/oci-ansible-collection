...
.. _ansible_collections.oracle.oci.oci_oda_channel_actions_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_oda_channel_actions`.
                        ...
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li>rotate_channel_keys</li>
                                                                                                                                                                                                <li>start</li>
                                                                                                                                                                                                <li>stop</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                                            <div>The action to perform on the Channel.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
