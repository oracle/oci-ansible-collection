...
.. _ansible_collections.oracle.oci.oci_analytics_private_access_channel_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_analytics_private_access_channel`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                            ...
                                            <div>Required for update using <em>state=present</em> with analytics_instance_id present.</div>
                                            <div>Required for delete using <em>state=absent</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-private_source_dns_zones"></div>
                    <b>private_source_dns_zones</b>
                    <a class="ansibleOptionLink" href="#parameter-private_source_dns_zones" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=dictionary</span>                                            </div>
                                ...
                                <td>
                                        ...
                                        <tr>
                                                ...
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-private_source_dns_zones/description"></div>
                    <b>description</b>
                    <a class="ansibleOptionLink" href="#parameter-private_source_dns_zones/description" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                ...
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-private_source_dns_zones/dns_zone"></div>
                    <b>dns_zone</b>
                    <a class="ansibleOptionLink" href="#parameter-private_source_dns_zones/dns_zone" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                 / <span style="color: red">required</span>                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the PrivateAccessChannel.</div>
                                            <div>Use <em>state=present</em> to create or update a PrivateAccessChannel.</div>
                                            <div>Use <em>state=absent</em> to delete a PrivateAccessChannel.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
