...
- This resource has the following action operations in the :ref:`oci_autonomous_database_actions <ansible_collections.oci_autonomous_database_actions_module>` module: deregister_autonomous_database_data_safe, fail_over, generate_autonomous_database_wallet, register_autonomous_database_data_safe, restart, restore, start, stop, switchover.
