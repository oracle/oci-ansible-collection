...
.. _ansible_collections.oracle.oci.oci_opsi_exadata_insights_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_opsi_exadata_insights`.
...
- This resource has the following action operations in the :ref:`oracle.oci.oci_opsi_exadata_insights_actions <ansible_collections.oracle.oci.oci_opsi_exadata_insights_actions_module>` module: change.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Compartment Identifier of Exadata insight</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                            ...
                                            <div>Required for create using <em>state=present</em>, update using <em>state=present</em> with exadata_insight_id present.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the ExadataInsights.</div>
                                            <div>Use <em>state=present</em> to create or update an ExadataInsights.</div>
                                            <div>Use <em>state=absent</em> to delete an ExadataInsights.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
