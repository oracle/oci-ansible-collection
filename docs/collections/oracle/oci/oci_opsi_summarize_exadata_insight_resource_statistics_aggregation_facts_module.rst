...
.. _ansible_collections.oracle.oci.oci_opsi_summarize_exadata_insight_resource_statistics_aggregation_facts_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_opsi_summarize_exadata_insight_resource_statistics_aggregation_facts`.
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-summarize_exadata_insight_resource_statistics_aggregations"></div>
                    <b>summarize_exadata_insight_resource_statistics_aggregations</b>
                    <a class="ansibleOptionLink" href="#return-summarize_exadata_insight_resource_statistics_aggregations" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>on success</td>
                <td>
                                            <div>List of SummarizeExadataInsightResourceStatisticsAggregation resources</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[{&#x27;exadata_resource_type&#x27;: &#x27;DATABASE&#x27;}]</div>
                                    </td>
            </tr>
                                        <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-summarize_exadata_insight_resource_statistics_aggregations/exadata_resource_type"></div>
                    <b>exadata_resource_type</b>
                    <a class="ansibleOptionLink" href="#return-summarize_exadata_insight_resource_statistics_aggregations/exadata_resource_type" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>Defines the resource type for an exadata  (example: DATABASE, STORAGE_SERVER, HOST, DISKGROUP)</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
