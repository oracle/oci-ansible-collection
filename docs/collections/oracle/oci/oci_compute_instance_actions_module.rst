...
- For more information about managing instance lifecycle states, see `Stopping and Starting an Instance <https://docs.cloud.oracle.com/Content/Compute/Tasks/restartinginstance.htm>`_.
