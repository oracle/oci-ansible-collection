            ...
            <th width="100%">Description</th>
                ...
                <td>
                                ...
                                <tr>
                                    ...
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-resource_usage_trend/usage_data/total_host_capacity"></div>
                    <b>total_host_capacity</b>
                    <a class="ansibleOptionLink" href="#return-resource_usage_trend/usage_data/total_host_capacity" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">float</span>
                                          </div>
                                    </td>
