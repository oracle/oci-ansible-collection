...
.. _ansible_collections.oracle.oci.oci_container_instances_container_instance_actions_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_container_instances_container_instance_actions`.
...
- For *action=change_compartment*, moves a ContainerInstance resource from one compartment identifier to another. When provided, If-Match is checked against ETag values of the resource.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The action to perform on the ContainerInstance.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
