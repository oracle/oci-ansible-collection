...
.. _ansible_collections.oracle.oci.oci_network_cross_connect_actions_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_network_cross_connect_actions`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The action to perform on the CrossConnect.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The <a href='https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm'>OCID</a> of the compartment to move the cross-connect to.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="return-cross_connect/oci_logical_device_name"></div>
                    <b>oci_logical_device_name</b>
                    <a class="ansibleOptionLink" href="#return-cross_connect/oci_logical_device_name" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="return-cross_connect/oci_physical_device_name"></div>
                    <b>oci_physical_device_name</b>
                    <a class="ansibleOptionLink" href="#return-cross_connect/oci_physical_device_name" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
