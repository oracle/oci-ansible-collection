...
.. _ansible_collections.oracle.oci.oci_os_management_hub_software_source_actions_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_os_management_hub_software_source_actions`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The <a href='https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm'>OCID</a> of the compartment to move the software source to.</div>
                        ...
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>                                            </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>List of packages specified by the full package name (NEVRA.rpm).</div>
                                            <div>Required for <em>action=add_packages</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
