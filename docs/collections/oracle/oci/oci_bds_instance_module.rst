...
.. _ansible_collections.oracle.oci.oci_bds_instance_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_bds_instance`.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="parameter-cluster_profile"></div>
                    <b>cluster_profile</b>
                    <a class="ansibleOptionLink" href="#parameter-cluster_profile" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The SSH public key used to authenticate the cluster connection.</div>
                                            <div>Required for create using <em>state=present</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Name of the Big Data Service cluster.</div>
                                            <div>Required for create using <em>state=present</em>.</div>
                        ...
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=dictionary</span>                                            </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The list of nodes in the Big Data Service cluster.</div>
                                            <div>Required for create using <em>state=present</em>.</div>
                                                        </td>
            </tr>
                                        <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The size of block volume in GB to be attached to a given node. All the details needed for attaching the block volume are managed by service itself.</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The Big Data Service cluster node type.</div>
                                                        </td>
            </tr>
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <tr>
                                    ...
                                    <td class="elbow-placeholder"></td>
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-nodes/shape_config/nvmes"></div>
                    <b>nvmes</b>
                    <a class="ansibleOptionLink" href="#parameter-nodes/shape_config/nvmes" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                                                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The OCID of the subnet in which the node will be created.</div>
                                                        </td>
            </tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the BdsInstance.</div>
                                            <div>Use <em>state=present</em> to create or update a BdsInstance.</div>
                                            <div>Use <em>state=absent</em> to delete a BdsInstance.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="3">
