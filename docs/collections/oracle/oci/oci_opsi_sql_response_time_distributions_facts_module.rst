...
.. _ansible_collections.oracle.oci.oci_opsi_sql_response_time_distributions_facts_module:
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Unique SQL_ID for a SQL Statement. Example: `6rgjh9bjmy2s7`</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-sql_response_time_distributions"></div>
                    <b>sql_response_time_distributions</b>
                    <a class="ansibleOptionLink" href="#return-sql_response_time_distributions" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>
                                ...
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-sql_response_time_distributions/bucket_id"></div>
                    <b>bucket_id</b>
                    <a class="ansibleOptionLink" href="#return-sql_response_time_distributions/bucket_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-sql_response_time_distributions/executions_count"></div>
                    <b>executions_count</b>
                    <a class="ansibleOptionLink" href="#return-sql_response_time_distributions/executions_count" title="Permalink to this return value"></a>
                    <div style="font-size: small">
