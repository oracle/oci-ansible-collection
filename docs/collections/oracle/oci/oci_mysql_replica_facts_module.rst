...
.. _ansible_collections.oracle.oci.oci_mysql_replica_facts_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_mysql_replica_facts`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                            ...
                                            <div>Required to list multiple replicas.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The LifecycleState of the read replica.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                            ...
                                            <div>Required to get a specific replica.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The field to sort by. You can sort by one field only. By default, the Time field is sorted in descending order and the Display Name field in ascending order.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
