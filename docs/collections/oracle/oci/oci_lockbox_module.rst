...
.. _ansible_collections.oracle.oci.oci_lockbox_module:
...
oracle.oci.oci_lockbox -- Manage a Lockbox resource in Oracle Cloud Infrastructure
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_lockbox`.
...
- For *state=present*, creates a new Lockbox.
- This resource has the following action operations in the :ref:`oracle.oci.oci_lockbox_actions <ansible_collections.oracle.oci.oci_lockbox_actions_module>` module: change_compartment.
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <tr>
                                                                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="parameter-access_context_attributes"></div>
                    <b>access_context_attributes</b>
                    <a class="ansibleOptionLink" href="#parameter-access_context_attributes" title="Permalink to this option"></a>
                        ...
                        <span style="color: purple">dictionary</span>
                                ...
                                <td>
                                        ...
                                        <tr>
                                                ...
                                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-access_context_attributes/items"></div>
                    <b>items</b>
                    <a class="ansibleOptionLink" href="#parameter-access_context_attributes/items" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=dictionary</span>                         / <span style="color: red">required</span>                    </div>
                                ...
                                <td>
                                    ...
                                    <td class="elbow-placeholder"></td>
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-access_context_attributes/items/default_value"></div>
                    <b>default_value</b>
                    <a class="ansibleOptionLink" href="#parameter-access_context_attributes/items/default_value" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                    ...
                                    <td class="elbow-placeholder"></td>
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-access_context_attributes/items/description"></div>
                    <b>description</b>
                    <a class="ansibleOptionLink" href="#parameter-access_context_attributes/items/description" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td class="elbow-placeholder"></td>
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-access_context_attributes/items/name"></div>
                    <b>name</b>
                    <a class="ansibleOptionLink" href="#parameter-access_context_attributes/items/name" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="parameter-approval_template_id"></div>
                    <b>approval_template_id</b>
                    <a class="ansibleOptionLink" href="#parameter-approval_template_id" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="parameter-lockbox_partner"></div>
                    <b>lockbox_partner</b>
                    <a class="ansibleOptionLink" href="#parameter-lockbox_partner" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                ...
                                <tr>
                                                                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="parameter-max_access_duration"></div>
                    <b>max_access_duration</b>
                    <a class="ansibleOptionLink" href="#parameter-max_access_duration" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                ...
                                <tr>
                                                                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="parameter-partner_compartment_id"></div>
                    <b>partner_compartment_id</b>
                    <a class="ansibleOptionLink" href="#parameter-partner_compartment_id" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The unique identifier (OCID) of the customer&#x27;s resource.</div>
                                            <div>Required for create using <em>state=present</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the Lockbox.</div>
                                            <div>Use <em>state=present</em> to create or update a Lockbox.</div>
                                            <div>Use <em>state=absent</em> to delete a Lockbox.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="3">
