...
.. _ansible_collections.oracle.oci.oci_identity_api_key_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_identity_api_key`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The public key.  Must be an RSA key in PEM format.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the ApiKey.</div>
                                            <div>Use <em>state=present</em> to create an ApiKey.</div>
                                            <div>Use <em>state=absent</em> to delete an ApiKey.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>on success</td>
                <td>
                                            <div>Details of the ApiKey resource acted upon by the current operation</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;fingerprint&#x27;: &#x27;fingerprint_example&#x27;, &#x27;inactive_status&#x27;: 56, &#x27;key_id&#x27;: &#x27;ocid1.key.oc1..xxxxxxEXAMPLExxxxxx&#x27;, &#x27;key_value&#x27;: &#x27;key_value_example&#x27;, &#x27;lifecycle_state&#x27;: &#x27;CREATING&#x27;, &#x27;time_created&#x27;: &#x27;2013-10-20T19:20:30+01:00&#x27;, &#x27;user_id&#x27;: &#x27;ocid1.user.oc1..xxxxxxEXAMPLExxxxxx&#x27;}</div>
                                    </td>
            </tr>
                                        <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-api_key/fingerprint"></div>
                    <b>fingerprint</b>
                    <a class="ansibleOptionLink" href="#return-api_key/fingerprint" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>The key&#x27;s fingerprint (e.g., 12:34:56:78:90:ab:cd:ef:12:34:56:78:90:ab:cd:ef).</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-api_key/inactive_status"></div>
                    <b>inactive_status</b>
                    <a class="ansibleOptionLink" href="#return-api_key/inactive_status" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">integer</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-api_key/key_id"></div>
                    <b>key_id</b>
                    <a class="ansibleOptionLink" href="#return-api_key/key_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>An Oracle-assigned identifier for the key, in this format: TENANCY_OCID/USER_OCID/KEY_FINGERPRINT.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-api_key/key_value"></div>
                    <b>key_value</b>
                    <a class="ansibleOptionLink" href="#return-api_key/key_value" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                        ...
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">key_value_example</div>
                                    </td>
            </tr>
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-api_key/lifecycle_state"></div>
                    <b>lifecycle_state</b>
                    <a class="ansibleOptionLink" href="#return-api_key/lifecycle_state" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>The API key&#x27;s current state. After creating an `ApiKey` object, make sure its `lifecycleState` changes from CREATING to ACTIVE before using it.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-api_key/time_created"></div>
                    <b>time_created</b>
                    <a class="ansibleOptionLink" href="#return-api_key/time_created" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-api_key/user_id"></div>
                    <b>user_id</b>
                    <a class="ansibleOptionLink" href="#return-api_key/user_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>The OCID of the user the key belongs to.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
