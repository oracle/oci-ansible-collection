...
- This resource has the following action operations in the M(oci_autonomous_container_database_actions) module: change_compartment, restart, rotate_autonomous_container_database_encryption_key.
