...
.. _ansible_collections.oracle.oci.oci_opsi_addm_db_parameter_change_aggregation_facts_module:
...
oracle.oci.oci_opsi_addm_db_parameter_change_aggregation_facts -- Fetches details about one or multiple AddmDbParameterChangeAggregation resources in Oracle Cloud Infrastructure
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_opsi_addm_db_parameter_change_aggregation_facts`.
...
- Fetches details about one or multiple AddmDbParameterChangeAggregation resources in Oracle Cloud Infrastructure
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Required filter to return only changes for the specified parameter. The match is case sensitive.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Field name for sorting the database parameter change data</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-value_contains"></div>
                    <b>value_contains</b>
                    <a class="ansibleOptionLink" href="#parameter-value_contains" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>Optional filter to return only resources whose value contains the substring given. The match is not case sensitive.</div>
                                                        </td>
            </tr>
                        </table>
    <br/>
...
.. code-block:: yaml+jinja
    ...
    - name: List addm_db_parameter_change_aggregations
      oci_opsi_addm_db_parameter_change_aggregation_facts:
        # required
        ...
        value_contains: value_contains_example
        sort_order: ASC
        sort_by: isChanged
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-addm_db_parameter_change_aggregations"></div>
                    <b>addm_db_parameter_change_aggregations</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_parameter_change_aggregations" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>on success</td>
                <td>
                                            <div>List of AddmDbParameterChangeAggregation resources</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[{&#x27;id&#x27;: &#x27;ocid1.resource.oc1..xxxxxxEXAMPLExxxxxx&#x27;, &#x27;inst_num&#x27;: 56, &#x27;previous_value&#x27;: &#x27;previous_value_example&#x27;, &#x27;snapshot_id&#x27;: 56, &#x27;time_begin&#x27;: &#x27;2013-10-20T19:20:30+01:00&#x27;, &#x27;time_end&#x27;: &#x27;2013-10-20T19:20:30+01:00&#x27;, &#x27;value&#x27;: &#x27;value_example&#x27;}]</div>
                                    </td>
            </tr>
                                        <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_parameter_change_aggregations/id"></div>
                    <b>id</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_parameter_change_aggregations/id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_parameter_change_aggregations/inst_num"></div>
                    <b>inst_num</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_parameter_change_aggregations/inst_num" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_parameter_change_aggregations/previous_value"></div>
                    <b>previous_value</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_parameter_change_aggregations/previous_value" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                        ...
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">previous_value_example</div>
                                    </td>
            </tr>
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_parameter_change_aggregations/snapshot_id"></div>
                    <b>snapshot_id</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_parameter_change_aggregations/snapshot_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">integer</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>AWR snapshot id which includes the parameter value change</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">56</div>
                                    </td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_parameter_change_aggregations/time_begin"></div>
                    <b>time_begin</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_parameter_change_aggregations/time_begin" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>Begin time of interval which includes change</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_parameter_change_aggregations/time_end"></div>
                    <b>time_end</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_parameter_change_aggregations/time_end" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>End time of interval which includes change</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">2013-10-20T19:20:30+01:00</div>
                                    </td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_parameter_change_aggregations/value"></div>
                    <b>value</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_parameter_change_aggregations/value" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
