...
.. _ansible_collections.oracle.oci.oci_opsi_addm_db_finding_category_facts_module:
...
oracle.oci.oci_opsi_addm_db_finding_category_facts -- Fetches details about one or multiple AddmDbFindingCategory resources in Oracle Cloud Infrastructure
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_opsi_addm_db_finding_category_facts`.
...
- Fetches details about one or multiple AddmDbFindingCategory resources in Oracle Cloud Infrastructure
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Field name for sorting the finding categories</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
...
.. code-block:: yaml+jinja
    ...
    - name: List addm_db_finding_categories
      oci_opsi_addm_db_finding_category_facts:
        # required
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-addm_db_finding_categories"></div>
                    <b>addm_db_finding_categories</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_finding_categories" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>on success</td>
                <td>
                                            <div>List of AddmDbFindingCategory resources</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[{&#x27;display_name&#x27;: &#x27;display_name_example&#x27;, &#x27;id&#x27;: &#x27;ocid1.resource.oc1..xxxxxxEXAMPLExxxxxx&#x27;, &#x27;name&#x27;: &#x27;name_example&#x27;}]</div>
                                    </td>
            </tr>
                                        <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_finding_categories/display_name"></div>
                    <b>display_name</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_finding_categories/display_name" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>Display name of finding category</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_finding_categories/id"></div>
                    <b>id</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_finding_categories/id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_finding_categories/name"></div>
                    <b>name</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_finding_categories/name" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>Name of finding category</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
