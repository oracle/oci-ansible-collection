...
.. _ansible_collections.oracle.oci.oci_identity_domain_actions_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_identity_domain_actions`.
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li>activate</li>
                                                                                                                                                                                                ...
                                                                                                                                                                                                <li>change_domain_license_type</li>
                                                                                                                                                                                                <li>deactivate</li>
                                                                                                                                                                                                <li>enable_replication_to_region</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                                            <div>The action to perform on the Domain.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
