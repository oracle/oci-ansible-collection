...
.. _ansible_collections.oracle.oci.oci_network_ip_sec_connection_tunnel_shared_secret_module:
...
oracle.oci.oci_network_ip_sec_connection_tunnel_shared_secret -- Manage an IpSecConnectionTunnelSharedSecret resource in Oracle Cloud Infrastructure
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-shared_secret"></div>
                    <b>shared_secret</b>
                    <a class="ansibleOptionLink" href="#parameter-shared_secret" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>The shared secret (pre-shared key) to use for the tunnel. Only numbers, letters, and spaces are allowed.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the IpSecConnectionTunnelSharedSecret.</div>
                                            <div>Use <em>state=present</em> to update an existing an IpSecConnectionTunnelSharedSecret.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-ip_sec_connection_tunnel_shared_secret"></div>
                    <b>ip_sec_connection_tunnel_shared_secret</b>
                    <a class="ansibleOptionLink" href="#return-ip_sec_connection_tunnel_shared_secret" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>
                                ...
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-ip_sec_connection_tunnel_shared_secret/shared_secret"></div>
                    <b>shared_secret</b>
                    <a class="ansibleOptionLink" href="#return-ip_sec_connection_tunnel_shared_secret/shared_secret" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
