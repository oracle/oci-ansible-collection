...
- This resource has the following action operations in the :ref:`oci_log_analytics_object_collection_rule_actions <ansible_collections.oci_log_analytics_object_collection_rule_actions_module>` module: change_compartment.
