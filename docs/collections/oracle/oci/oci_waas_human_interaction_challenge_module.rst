...
.. _ansible_collections.oracle.oci.oci_waas_human_interaction_challenge_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_waas_human_interaction_challenge`.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <tr>
                                                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-interaction_threshold"></div>
                    <b>interaction_threshold</b>
                    <a class="ansibleOptionLink" href="#parameter-interaction_threshold" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                                                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <tr>
                                                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-recording_period_in_seconds"></div>
                    <b>recording_period_in_seconds</b>
                    <a class="ansibleOptionLink" href="#parameter-recording_period_in_seconds" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                                                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the HumanInteractionChallenge.</div>
                                            <div>Use <em>state=present</em> to update an existing a HumanInteractionChallenge.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>on success</td>
                <td>
                                            <div>Details of the HumanInteractionChallenge resource acted upon by the current operation</div>
                                        <br/>
