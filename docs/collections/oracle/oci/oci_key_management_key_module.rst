...
- This resource has the following action operations in the M(oci_key_actions) module: cancel_key_deletion, change_compartment, disable, enable, schedule_key_deletion.
