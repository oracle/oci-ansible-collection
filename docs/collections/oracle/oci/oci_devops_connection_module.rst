...
- This resource has the following action operations in the :ref:`oracle.oci.oci_devops_connection_actions <ansible_collections.oracle.oci.oci_devops_connection_actions_module>` module: validate.
