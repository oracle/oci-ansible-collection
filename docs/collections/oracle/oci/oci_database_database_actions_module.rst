...
- For *action=change_key_store_type*, changes encryption key management type
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                            ...
                                            <div>Required for <em>action=change_key_store_type</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
