...
.. _ansible_collections.oracle.oci.oci_opsi_addm_db_sql_statement_facts_module:
...
oracle.oci.oci_opsi_addm_db_sql_statement_facts -- Fetches details about one or multiple AddmDbSqlStatement resources in Oracle Cloud Infrastructure
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_opsi_addm_db_sql_statement_facts`.
...
- Fetches details about one or multiple AddmDbSqlStatement resources in Oracle Cloud Infrastructure
...
.. code-block:: yaml+jinja
    ...
    - name: List addm_db_sql_statements
      oci_opsi_addm_db_sql_statement_facts:
        # required
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-addm_db_sql_statements"></div>
                    <b>addm_db_sql_statements</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_sql_statements" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>on success</td>
                <td>
                                            <div>List of AddmDbSqlStatement resources</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[{&#x27;id&#x27;: &#x27;ocid1.resource.oc1..xxxxxxEXAMPLExxxxxx&#x27;, &#x27;is_sql_text_truncated&#x27;: True, &#x27;sql_command&#x27;: &#x27;sql_command_example&#x27;, &#x27;sql_identifier&#x27;: &#x27;sql_identifier_example&#x27;, &#x27;sql_text&#x27;: &#x27;sql_text_example&#x27;}]</div>
                                    </td>
            </tr>
                                        <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_sql_statements/id"></div>
                    <b>id</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_sql_statements/id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_sql_statements/is_sql_text_truncated"></div>
                    <b>is_sql_text_truncated</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_sql_statements/is_sql_text_truncated" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">boolean</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_sql_statements/sql_command"></div>
                    <b>sql_command</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_sql_statements/sql_command" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_sql_statements/sql_identifier"></div>
                    <b>sql_identifier</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_sql_statements/sql_identifier" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-addm_db_sql_statements/sql_text"></div>
                    <b>sql_text</b>
                    <a class="ansibleOptionLink" href="#return-addm_db_sql_statements/sql_text" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
