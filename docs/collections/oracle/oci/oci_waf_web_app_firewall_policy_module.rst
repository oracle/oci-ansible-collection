...
- This resource has the following action operations in the :ref:`oci_web_app_firewall_policy_actions <ansible_collections.oci_web_app_firewall_policy_actions_module>` module: change_compartment.
