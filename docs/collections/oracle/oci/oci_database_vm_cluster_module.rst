...
.. _ansible_collections.oracle.oci.oci_database_vm_cluster_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_database_vm_cluster`.
...
- This resource has the following action operations in the :ref:`oracle.oci.oci_database_vm_cluster_actions <ansible_collections.oracle.oci.oci_database_vm_cluster_actions_module>` module: add_virtual_machine, change_compartment, remove_virtual_machine.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The number of CPU cores to enable for the VM cluster.</div>
                                            <div>Required for create using <em>state=present</em>.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">float</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The data disk group size to be allocated in GBs.</div>
                                            <div>This parameter is updatable.</div>
                                                        </td>
            </tr>
                                <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">float</span>
                                ...
                                <tr>
                                                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-db_node_storage_size_in_gbs"></div>
                    <b>db_node_storage_size_in_gbs</b>
                    <a class="ansibleOptionLink" href="#parameter-db_node_storage_size_in_gbs" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                                                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>If true, the sparse disk group is configured for the VM cluster. If false, the sparse disk group is not created.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The Oracle license model that applies to the VM cluster. The default is BRING_YOUR_OWN_LICENSE.</div>
                                            <div>This parameter is updatable.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-memory_size_in_gbs"></div>
                    <b>memory_size_in_gbs</b>
                    <a class="ansibleOptionLink" href="#parameter-memory_size_in_gbs" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                                                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">float</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The number of OCPU cores to enable for the VM cluster. Only one decimal place is allowed for the fractional part.</div>
                                            <div>This parameter is updatable.</div>
                                                        </td>
            </tr>
                                <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the VmCluster.</div>
                                            <div>Use <em>state=present</em> to create or update a VmCluster.</div>
                                            <div>Use <em>state=absent</em> to delete a VmCluster.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The time zone to use for the VM cluster. For details, see <a href='https://docs.cloud.oracle.com/Content/Database/References/timezones.htm'>DB System Time Zones</a>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The update action to perform.</div>
                                            <div>This parameter is updatable.</div>
                                                        </td>
            </tr>
                                <tr>
