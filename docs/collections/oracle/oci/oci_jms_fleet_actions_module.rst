...
.. _ansible_collections.oracle.oci.oci_jms_fleet_actions_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_jms_fleet_actions`.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The action to perform on the Fleet.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="3">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The <a href='https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm'>OCID</a> of the compartment into which the Fleet should be moved.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                            ...
                                            <div>Required for <em>action=generate_agent_deploy_script</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="3">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The <a href='https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm'>OCID</a> of the install key for which to generate the script.</div>
                                            <div>Required for <em>action=generate_agent_deploy_script</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Enable/disable user name collection on agent.</div>
                                            <div>Required for <em>action=generate_agent_deploy_script</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="parameter-manage_drs_details"></div>
                    <b>manage_drs_details</b>
                    <a class="ansibleOptionLink" href="#parameter-manage_drs_details" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">dictionary</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div></div>
                                            <div>Applicable only for <em>action=disable_drs</em><em>action=enable_drs</em>.</div>
                                                        </td>
            </tr>
                                        <tr>
                                                    <td class="elbow-placeholder"></td>
                                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-manage_drs_details/targets"></div>
                    <b>targets</b>
                    <a class="ansibleOptionLink" href="#parameter-manage_drs_details/targets" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=dictionary</span>                                            </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The targets to manage DRS.</div>
                                                        </td>
            </tr>
                                        <tr>
                                                    <td class="elbow-placeholder"></td>
                                    <td class="elbow-placeholder"></td>
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-manage_drs_details/targets/managed_instance_id"></div>
                    <b>managed_instance_id</b>
                    <a class="ansibleOptionLink" href="#parameter-manage_drs_details/targets/managed_instance_id" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                 / <span style="color: red">required</span>                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>OCID of the managed instance to manage DRS distribution.</div>
                                                        </td>
            </tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The operating system type for the script. Currently only &#x27;LINUX&#x27; and &#x27;WINDOWS&#x27; are supported.</div>
                                            <div>Required for <em>action=generate_agent_deploy_script</em>.</div>
                                                        </td>
            </tr>
                                <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-fleet/is_advanced_features_enabled"></div>
                    <b>is_advanced_features_enabled</b>
                    <a class="ansibleOptionLink" href="#return-fleet/is_advanced_features_enabled" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">boolean</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-fleet/is_export_setting_enabled"></div>
                    <b>is_export_setting_enabled</b>
                    <a class="ansibleOptionLink" href="#return-fleet/is_export_setting_enabled" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">boolean</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>Whether or not export setting is enabled in this Fleet.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">True</div>
                                    </td>
