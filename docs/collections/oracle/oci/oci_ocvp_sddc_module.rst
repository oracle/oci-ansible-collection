...
- This resource has the following action operations in the M(oci_sddc_actions) module: cancel_downgrade_hcx, change_compartment, downgrade_hcx, refresh_hcx_license_status, upgrade_hcx.
