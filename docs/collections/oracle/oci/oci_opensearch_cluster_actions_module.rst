...
.. _ansible_collections.oracle.oci.oci_opensearch_cluster_actions_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_opensearch_cluster_actions`.
                        ...
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li>backup</li>
                                                                                                                                                                                                <li>opensearch_cluster_restore</li>
                                                                                                                                                                                                <li>resize_opensearch_cluster_horizontal</li>
                                                                                                                                                                                                <li>resize_opensearch_cluster_vertical</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                                            <div>The action to perform on the OpensearchCluster.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                            ...
                                            <div>Required for <em>action=backup</em>, <em>action=opensearch_cluster_restore</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                            ...
                                            <div>Applicable only for <em>action=resize_opensearch_cluster_horizontal</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The amount of memory in GB, to configure for the cluster&#x27;s data nodes.</div>
                                            <div>Applicable only for <em>action=resize_opensearch_cluster_vertical</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">dictionary</span>
                                ...
                                <td>
                                            ...
                                            <div>Applicable only for <em>action=resize_opensearch_cluster_horizontal</em><em>action=resize_opensearch_cluster_vertical</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                            ...
                                            <div>Required for <em>action=backup</em>.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The amount of memory in GB, to configure for the cluster&#x27;s master nodes.</div>
                                            <div>Applicable only for <em>action=resize_opensearch_cluster_vertical</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The number of OCPUs to configure for the cluster&#x27;s master nodes.</div>
                                            <div>Applicable only for <em>action=resize_opensearch_cluster_vertical</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The OCID of the cluster backup to restore.</div>
                                            <div>Required for <em>action=opensearch_cluster_restore</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The prefix for the indices in the cluster backup.</div>
                                            <div>Applicable only for <em>action=opensearch_cluster_restore</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
