...
.. _ansible_collections.oracle.oci.oci_management_dashboard_facts_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_management_dashboard_facts`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The field to sort by. Only one sort order may be provided. Default order for timeCreated is descending. Default order for displayName is ascending. If no value is specified timeCreated is the default.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
