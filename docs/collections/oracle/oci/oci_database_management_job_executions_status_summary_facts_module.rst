...
.. _ansible_collections.oracle.oci.oci_database_management_job_executions_status_summary_facts_module:
...
oracle.oci.oci_database_management_job_executions_status_summary_facts -- Fetches details about one or multiple JobExecutionsStatusSummary resources in Oracle Cloud Infrastructure
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_database_management_job_executions_status_summary_facts`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The end time of the time range to retrieve the status summary of job executions in UTC in ISO-8601 format, which is &quot;yyyy-MM-dd&#x27;T&#x27;hh:mm:ss.sss&#x27;Z&#x27;&quot;.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The identifier of the resource.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The start time of the time range to retrieve the status summary of job executions in UTC in ISO-8601 format, which is &quot;yyyy-MM-dd&#x27;T&#x27;hh:mm:ss.sss&#x27;Z&#x27;&quot;.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-job_executions_status_summaries"></div>
                    <b>job_executions_status_summaries</b>
                    <a class="ansibleOptionLink" href="#return-job_executions_status_summaries" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>on success</td>
                <td>
                                            <div>List of JobExecutionsStatusSummary resources</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[{&#x27;count&#x27;: 56, &#x27;status&#x27;: &#x27;SUCCEEDED&#x27;}]</div>
                                    </td>
            </tr>
                                        <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-job_executions_status_summaries/count"></div>
                    <b>count</b>
                    <a class="ansibleOptionLink" href="#return-job_executions_status_summaries/count" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>on success</td>
                <td>
                                            <div>The number of job executions of a particular status.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-job_executions_status_summaries/status"></div>
                    <b>status</b>
                    <a class="ansibleOptionLink" href="#return-job_executions_status_summaries/status" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
