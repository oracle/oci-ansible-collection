        ...
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                    ...
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-virtual_circuit/public_prefixes/cidr_block"></div>
                    <b>cidr_block</b>
                    <a class="ansibleOptionLink" href="#return-virtual_circuit/public_prefixes/cidr_block" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
