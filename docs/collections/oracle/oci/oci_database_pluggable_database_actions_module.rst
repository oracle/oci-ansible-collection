...
.. _ansible_collections.oracle.oci.oci_database_pluggable_database_actions_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_database_pluggable_database_actions`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The action to perform on the PluggableDatabase.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>A strong password for PDB Admin of the newly cloned PDB. The password must be at least nine characters and contain at least two uppercase, two lowercase, two numbers, and two special characters. The special characters must be _, #, or -.</div>
                                            <div>Applicable only for <em>action=local_clone</em><em>action=remote_clone</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The DB system administrator password of the source CDB.</div>
                                            <div>Required for <em>action=remote_clone</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The <a href='https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm'>OCID</a> of the target CDB</div>
                                            <div>Required for <em>action=remote_clone</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The existing TDE wallet password of the target CDB.</div>
                                            <div>Applicable only for <em>action=local_clone</em><em>action=remote_clone</em>.</div>
                                                        </td>
            </tr>
                                <tr>
