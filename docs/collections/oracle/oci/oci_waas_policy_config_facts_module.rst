...
.. _ansible_collections.oracle.oci.oci_waas_policy_config_facts_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_waas_policy_config_facts`.
