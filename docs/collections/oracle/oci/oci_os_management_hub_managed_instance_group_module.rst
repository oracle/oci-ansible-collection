...
.. _ansible_collections.oracle.oci.oci_os_management_hub_managed_instance_group_module:
...
oracle.oci.oci_os_management_hub_managed_instance_group -- Manage a ManagedInstanceGroup resource in Oracle Cloud Infrastructure
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_os_management_hub_managed_instance_group`.
...
- For *state=present*, creates a new managed instance group.
- This resource has the following action operations in the :ref:`oracle.oci.oci_os_management_hub_managed_instance_group_actions <ansible_collections.oracle.oci.oci_os_management_hub_managed_instance_group_actions_module>` module: attach_managed_instances, attach_software_sources, change_compartment, detach_managed_instances, detach_software_sources, disable_module_stream, enable_module_stream, install_module_stream_profile, install_packages, install_windows_updates, manage_module_streams, remove_module_stream_profile, remove_packages, switch_module_stream, update_all_packages.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The CPU architecture type of the managed instances that will be attached to this group.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>User-specified description of the managed instance group. Avoid entering confidential information.</div>
                                            <div>This parameter is updatable.</div>
                                                        </td>
            </tr>
                                <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>A user-friendly name for the managed instance group. Does not have to be unique and you can change the name later. Avoid entering confidential information.</div>
                                            <div>Required for create using <em>state=present</em>.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The location of managed instances attached to the group. If no location is provided, the default is on premises.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-managed_instance_ids"></div>
                    <b>managed_instance_ids</b>
                    <a class="ansibleOptionLink" href="#parameter-managed_instance_ids" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>                                            </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>The list of managed instance <a href='https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm'>OCIDs</a> to be added to the group.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The operating system type of the managed instances that will be attached to this group.</div>
                                            <div>Required for create using <em>state=present</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                        ...
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>                                            </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The list of software source <a href='https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm'>OCIDs</a> available to the managed instances in the group.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The vendor of the operating system that will be used by the managed instances in the group.</div>
                                            <div>Required for create using <em>state=present</em>.</div>
                                                        </td>
            </tr>
                                <tr>
