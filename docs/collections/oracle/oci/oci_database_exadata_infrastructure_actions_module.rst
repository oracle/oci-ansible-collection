...
.. _ansible_collections.oracle.oci.oci_database_exadata_infrastructure_actions_module:
...
oracle.oci.oci_database_exadata_infrastructure_actions -- Perform actions on an ExadataInfrastructure resource in Oracle Cloud Infrastructure
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_database_exadata_infrastructure_actions`.
...
- For *action=activate*, activates the specified Exadata infrastructure resource. Applies to Exadata Cloud@Customer instances only.
- For *action=add_storage_capacity*, makes the storage capacity from additional storage servers available for VM Cluster consumption. Applies to Exadata Cloud@Customer instances only.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li>activate</li>
                                                                                                                                                                                                ...
                                                                                                                                                                                                <li>download_exadata_infrastructure_config_file</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                                            <div>The action to perform on the ExadataInfrastructure.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-activation_file"></div>
                    <b>activation_file</b>
                    <a class="ansibleOptionLink" href="#parameter-activation_file" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>The base 64 encoded contents of the activation zip file. You can use the ansible &#x27;lookup&#x27; and &#x27;b64encode&#x27; functionality to read a file and base 64 encode its contents. For example: {{ lookup(&#x27;file&#x27;, &#x27;activation.zip&#x27;) | b64encode }}</div>
                                            <div>Required for <em>action=activate</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-config_file_dest"></div>
                    <b>config_file_dest</b>
                    <a class="ansibleOptionLink" href="#parameter-config_file_dest" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                <td>
                                                                ...
                                                                <td>
                                            <div>The destination file path to write the config file to when <em>action=download_exadata_infrastructure_config_file</em>. The file will be created if it does not exist. If the file already exists, the content will be overwritten. <em>config_file_dest</em> is required if <em>action=download_exadata_infrastructure_config_file</em>.</div>
                                            <div>Required for <em>action=download_exadata_infrastructure_config_file</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
