...
.. _ansible_collections.oracle.oci.oci_database_migration_migration_actions_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_database_migration_migration_actions`.
                        ...
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li>add_migration_objects</li>
                                                                                                                                                                                                <li>change_compartment</li>
                                                                                                                                                                                                <li>remove_migration_objects</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Database objects to exclude/include from migration in CSV format. The items field will be ignored if this field is not null.</div>
                                            <div>Applicable only for <em>action=add_migration_objects</em><em>action=remove_migration_objects</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                        ...
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=dictionary</span>                                            </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Database objects to exclude/include from migration</div>
                                            <div>Required for <em>action=add_migration_objects</em>, <em>action=remove_migration_objects</em>.</div>
                                                        </td>
            </tr>
                                        <tr>
                                                    <td class="elbow-placeholder"></td>
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-items/is_omit_excluded_table_from_replication"></div>
                    <b>is_omit_excluded_table_from_replication</b>
                    <a class="ansibleOptionLink" href="#parameter-items/is_omit_excluded_table_from_replication" title="Permalink to this option"></a>
                    <div style="font-size: small">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-items/object_status"></div>
                    <b>object_status</b>
                    <a class="ansibleOptionLink" href="#parameter-items/object_status" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                                ...
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-items/owner"></div>
                    <b>owner</b>
                    <a class="ansibleOptionLink" href="#parameter-items/owner" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                 / <span style="color: red">required</span>                    </div>
                                                        </td>
                                ...
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-items/type"></div>
                    <b>type</b>
                    <a class="ansibleOptionLink" href="#parameter-items/type" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
