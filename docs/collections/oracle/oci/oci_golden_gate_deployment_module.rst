...
- This resource has the following action operations in the :ref:`oci_deployment_actions <ansible_collections.oci_deployment_actions_module>` module: change_compartment, start, stop, upgrade.
