...
.. _ansible_collections.oracle.oci.oci_resource_manager_configuration_source_provider_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_resource_manager_configuration_source_provider`.
...
- This resource has the following action operations in the :ref:`oracle.oci.oci_resource_manager_configuration_source_provider_actions <ansible_collections.oracle.oci.oci_resource_manager_configuration_source_provider_actions_module>` module: change_compartment.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The <a href='https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm'>OCID</a> of the compartment where you want to create the configuration source provider.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Description of the configuration source provider. Avoid entering confidential information.</div>
                                            <div>This parameter is updatable.</div>
                                                        </td>
            </tr>
                                <tr>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Human-readable name of the configuration source provider. Avoid entering confidential information.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>                                            </div>
                                ...
                                <tr>
                                                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-private_server_config_details"></div>
                    <b>private_server_config_details</b>
                    <a class="ansibleOptionLink" href="#parameter-private_server_config_details" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">dictionary</span>
                                                                    </div>
                                                        </td>
                                <td>
                                        ...
                                        <tr>
                                                ...
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-private_server_config_details/certificate_id"></div>
                    <b>certificate_id</b>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                    <td class="elbow-placeholder"></td>
                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-private_server_config_details/private_endpoint_id"></div>
                    <b>private_endpoint_id</b>
                    <a class="ansibleOptionLink" href="#parameter-private_server_config_details/private_endpoint_id" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                 / <span style="color: red">required</span>                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the ConfigurationSourceProvider.</div>
                                            <div>Use <em>state=present</em> to create or update a ConfigurationSourceProvider.</div>
                                            <div>Use <em>state=absent</em> to delete a ConfigurationSourceProvider.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
