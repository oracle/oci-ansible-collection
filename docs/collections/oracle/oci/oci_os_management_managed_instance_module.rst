...
.. _ansible_collections.oracle.oci.oci_os_management_managed_instance_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_os_management_managed_instance`.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-is_data_collection_authorized"></div>
                    <b>is_data_collection_authorized</b>
                    <a class="ansibleOptionLink" href="#parameter-is_data_collection_authorized" title="Permalink to this option"></a>
                    <div style="font-size: small">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-notification_topic_id"></div>
                    <b>notification_topic_id</b>
                    <a class="ansibleOptionLink" href="#parameter-notification_topic_id" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the ManagedInstance.</div>
                                            <div>Use <em>state=present</em> to update an existing a ManagedInstance.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
