...
- This resource has the following action operations in the M(oci_database_insights_actions) module: change, disable, enable, ingest_database_configuration, ingest_sql_bucket, ingest_sql_plan_lines, ingest_sql_text.
