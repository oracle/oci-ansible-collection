...
.. _ansible_collections.oracle.oci.oci_key_management_key_version_actions_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_key_management_key_version_actions`.
                        ...
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li>cancel_key_version_deletion</li>
                                                                                                                                                                                                <li>schedule_key_version_deletion</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                                            <div>The action to perform on the KeyVersion.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>An optional property to indicate when to delete the key version, expressed in <a href='https://tools.ietf.org/html/rfc3339'>RFC 3339</a> timestamp format. The specified time must be between 7 and 30 days from the time when the request is received. If this property is missing, it will be set to 30 days from the time of the request by default.</div>
                                            <div>Applicable only for <em>action=schedule_key_version_deletion</em>.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
