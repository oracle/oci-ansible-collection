...
.. _ansible_collections.oracle.oci.oci_cloud_migrations_migration_actions_module:
...
oracle.oci.oci_cloud_migrations_migration_actions -- Perform actions on a Migration resource in Oracle Cloud Infrastructure
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_cloud_migrations_migration_actions`.
...
- For *action=change_compartment*, moves a migration resource from one compartment identifier to another. When provided, If-Match is checked against ETag values of the resource.
- For *action=refresh*, refreshes migration based on the migration ID.
- For *action=start_migration_replication*, starts replication for a migration or for some asset.
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li>change_compartment</li>
                                                                                                                                                                                                <li>refresh</li>
                                                                                                                                                                                                <li>start_migration_replication</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-migration/is_completed"></div>
                    <b>is_completed</b>
                    <a class="ansibleOptionLink" href="#return-migration/is_completed" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">boolean</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-migration/replication_schedule_id"></div>
                    <b>replication_schedule_id</b>
                    <a class="ansibleOptionLink" href="#return-migration/replication_schedule_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
