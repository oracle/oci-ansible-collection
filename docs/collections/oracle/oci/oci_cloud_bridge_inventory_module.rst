...
.. _ansible_collections.oracle.oci.oci_cloud_bridge_inventory_module:
...
oracle.oci.oci_cloud_bridge_inventory -- Manage an Inventory resource in Oracle Cloud Infrastructure
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_cloud_bridge_inventory`.
...
- For *state=present*, creates an inventory.
- This resource has the following action operations in the :ref:`oracle.oci.oci_cloud_bridge_inventory_actions <ansible_collections.oracle.oci.oci_cloud_bridge_inventory_actions_module>` module: import_inventory.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the Inventory.</div>
                                            <div>Use <em>state=present</em> to create or update an Inventory.</div>
                                            <div>Use <em>state=absent</em> to delete an Inventory.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
