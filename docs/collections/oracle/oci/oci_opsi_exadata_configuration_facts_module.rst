...
.. _ansible_collections.oracle.oci.oci_opsi_exadata_configuration_facts_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_opsi_exadata_configuration_facts`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li>exadataName</li>
                                                                                                                                                                                                <li>exadataDisplayName</li>
                                                                                                                                                                                                <li>exadataType</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                                            <div>Exadata configuration list sort options. If `fields` parameter is selected, the `sortBy` parameter must be one of the fields specified.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>on success</td>
                <td>
                                            <div>Source of the exadata entity.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
