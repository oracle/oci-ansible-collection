...
.. _ansible_collections.oracle.oci.oci_oda_instance_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_oda_instance`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Identifier of the compartment.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>User-friendly name for the instance. Avoid entering confidential information. You can change this value anytime.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the OdaInstance.</div>
                                            <div>Use <em>state=present</em> to create or update an OdaInstance.</div>
                                            <div>Use <em>state=absent</em> to delete an OdaInstance.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
