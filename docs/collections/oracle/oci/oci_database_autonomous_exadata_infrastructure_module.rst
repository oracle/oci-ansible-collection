...
- This resource has the following action operations in the M(oci_autonomous_exadata_infrastructure_actions) module: change_compartment, rotate_ords_certs, rotate_ssl_certs.
