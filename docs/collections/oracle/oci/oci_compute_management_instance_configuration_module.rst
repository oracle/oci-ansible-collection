...
- This resource has the following action operations in the :ref:`oci_instance_configuration_actions <ansible_collections.oci_instance_configuration_actions_module>` module: change_compartment, launch.
