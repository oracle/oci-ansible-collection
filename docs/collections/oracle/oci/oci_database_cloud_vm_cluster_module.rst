...
- This resource has the following action operations in the :ref:`oci_cloud_vm_cluster_actions <ansible_collections.oci_cloud_vm_cluster_actions_module>` module: change_compartment.
