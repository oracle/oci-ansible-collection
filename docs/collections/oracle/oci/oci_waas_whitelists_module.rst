...
.. _ansible_collections.oracle.oci.oci_waas_whitelists_module:
...
oracle.oci.oci_waas_whitelists -- Manage a Whitelists resource in Oracle Cloud Infrastructure
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_waas_whitelists`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the Whitelists.</div>
                                            <div>Use <em>state=present</em> to update an existing a Whitelists.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-whitelists"></div>
                    <b>whitelists</b>
                    <a class="ansibleOptionLink" href="#return-whitelists" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>on success</td>
                <td>
                                            <div>Details of the Whitelists resource acted upon by the current operation</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;address_lists&#x27;: [], &#x27;addresses&#x27;: [], &#x27;name&#x27;: &#x27;name_example&#x27;}</div>
                                    </td>
            </tr>
                                        <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-whitelists/address_lists"></div>
                    <b>address_lists</b>
                    <a class="ansibleOptionLink" href="#return-whitelists/address_lists" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                       / <span style="color: purple">elements=string</span>                    </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-whitelists/addresses"></div>
                    <b>addresses</b>
                    <a class="ansibleOptionLink" href="#return-whitelists/addresses" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">list</span>
                       / <span style="color: purple">elements=string</span>                    </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-whitelists/name"></div>
                    <b>name</b>
                    <a class="ansibleOptionLink" href="#return-whitelists/name" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
