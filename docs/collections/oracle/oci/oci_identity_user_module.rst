...
.. _ansible_collections.oracle.oci.oci_identity_user_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_identity_user`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                            ...
                                            <div>Use <em>state=present</em> to create or update an User.</div>
                                            <div>Use <em>state=absent</em> to delete an User.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
