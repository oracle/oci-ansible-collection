...
.. _ansible_collections.oracle.oci.oci_cims_validation_facts_module:
...
oracle.oci.oci_cims_validation_facts -- Fetches details about a Validation resource in Oracle Cloud Infrastructure
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_cims_validation_facts`.
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-validation"></div>
                    <b>validation</b>
                    <a class="ansibleOptionLink" href="#return-validation" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>on success</td>
                <td>
                                            <div>Validation resource</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;is_valid_user&#x27;: True}</div>
                                    </td>
            </tr>
                                        <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-validation/is_valid_user"></div>
                    <b>is_valid_user</b>
                    <a class="ansibleOptionLink" href="#return-validation/is_valid_user" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">boolean</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>Boolean value that indicates whether the requested user is valid.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
