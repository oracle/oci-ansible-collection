...
.. _ansible_collections.oracle.oci.oci_apm_traces_aggregated_snapshot_facts_module:
...
oracle.oci.oci_apm_traces_aggregated_snapshot_facts -- Fetches details about a AggregatedSnapshot resource in Oracle Cloud Infrastructure
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_apm_traces_aggregated_snapshot_facts`.
...
* ::
        ...
        Unable to normalize oci_apm_traces_aggregated_snapshot_facts: return due to: 1 validation error for PluginReturnSchema
        return -> aggregated_snapshot -> contains -> aggregated_stack_traces -> contains -> children -> contains -> stack_trace_element -> type
