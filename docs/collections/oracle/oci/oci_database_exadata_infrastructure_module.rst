...
- This resource has the following action operations in the M(oci_exadata_infrastructure_actions) module: activate, add_storage_capacity, change_compartment, download_exadata_infrastructure_config_file.
