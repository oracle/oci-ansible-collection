...
- For *action=create_detach_data_asset*, detaches list of DataAssets to the given endpoint
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>on success</td>
                <td>
                                            <div>Map of DataAsset name as key and results as value</div>
                                        <br/>
                                                        </td>
            </tr>
                                        <tr>
                ...
                <td>on success</td>
                <td>
                                            <div>Status of the validatio result execution</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
