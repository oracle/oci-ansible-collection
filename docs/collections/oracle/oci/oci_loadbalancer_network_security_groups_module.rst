...
.. _ansible_collections.oracle.oci.oci_loadbalancer_network_security_groups_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_loadbalancer_network_security_groups`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The <a href='https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm'>OCID</a> of the load balancer to update the NSGs for.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the NetworkSecurityGroups.</div>
                                            <div>Use <em>state=present</em> to update an existing a NetworkSecurityGroups.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>on success</td>
                <td>
                                            <div>Details of the NetworkSecurityGroups resource acted upon by the current operation</div>
                                        <br/>
