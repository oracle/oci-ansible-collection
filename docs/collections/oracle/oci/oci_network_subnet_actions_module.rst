...
.. _ansible_collections.oracle.oci.oci_network_subnet_actions_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_network_subnet_actions`.
                        ...
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li>add_ipv6_subnet_cidr</li>
                                                                                                                                                                                                <li>change_compartment</li>
                                                                                                                                                                                                <li>remove_ipv6_subnet_cidr</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                                            <div>The action to perform on the Subnet.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The <a href='https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm'>OCID</a> of the compartment to move the subnet to.</div>
