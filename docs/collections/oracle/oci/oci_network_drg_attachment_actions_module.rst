...
.. _ansible_collections.oracle.oci.oci_network_drg_attachment_actions_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_network_drg_attachment_actions`.
                        ...
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li>remove_export_drg_route_distribution</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                                            <div>The action to perform on the DrgAttachment.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
