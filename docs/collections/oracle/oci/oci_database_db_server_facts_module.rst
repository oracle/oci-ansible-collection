...
.. _ansible_collections.oracle.oci.oci_database_db_server_facts_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_database_db_server_facts`.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                            ...
                                            <div>Required to list multiple db_servers.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The DB server <a href='https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm'>OCID</a>.</div>
                                            <div>Required to get a specific db_server.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The <a href='https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm'>OCID</a> of the ExadataInfrastructure.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>on success</td>
                <td>
                                            <div>The number of CPU cores enabled on the Db server.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                ...
                <td>on success</td>
                <td>
                                            <div>The <a href='https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm'>OCID</a> of the Db nodes associated with the Db server.</div>
                                        <br/>
                                                        </td>
            </tr>
                                <tr>
                ...
                <td>on success</td>
                <td>
                                            <div>The allocated local node storage in GBs on the Db server.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">56</div>
                                    </td>
                ...
                <td>on success</td>
                <td>
                                            <div>The user-friendly name for the Db server. The name does not need to be unique.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                ...
                <td>on success</td>
                <td>
                                            <div>The current state of the Db server.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                ...
                <td>on success</td>
                <td>
                                            <div>The allocated memory in GBs on the Db server.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">56</div>
                                    </td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-db_servers/shape"></div>
                    <b>shape</b>
                    <a class="ansibleOptionLink" href="#return-db_servers/shape" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>The shape of the Db server. The shape determines the amount of CPU, storage, and memory resources available.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                ...
                <td>on success</td>
                <td>
                                            <div>The date and time that the Db Server was created.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">2013-10-20T19:20:30+01:00</div>
                                    </td>
                ...
                <td>on success</td>
                <td>
                                            <div>The <a href='https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm'>OCID</a> of the VM Clusters associated with the Db server.</div>
                                        <br/>
                                                        </td>
            </tr>
