...
.. _ansible_collections.oracle.oci.oci_identity_customer_secret_key_module:
...
oracle.oci.oci_identity_customer_secret_key -- Manage a CustomerSecretKey resource in Oracle Cloud Infrastructure
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_identity_customer_secret_key`.
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-customer_secret_key_id"></div>
                    <b>customer_secret_key_id</b>
                    <a class="ansibleOptionLink" href="#parameter-customer_secret_key_id" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The name you assign to the secret key during creation. Does not have to be unique, and it&#x27;s changeable.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The state of the CustomerSecretKey.</div>
                                            <div>Use <em>state=present</em> to create or update a CustomerSecretKey.</div>
                                            <div>Use <em>state=absent</em> to delete a CustomerSecretKey.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                    ...
                    <tr>
                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="return-customer_secret_key"></div>
                    <b>customer_secret_key</b>
                    <a class="ansibleOptionLink" href="#return-customer_secret_key" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                ...
                <td>
                                        ...
                                        <br/>
                                                ...
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{&#x27;display_name&#x27;: &#x27;display_name_example&#x27;, &#x27;id&#x27;: &#x27;ocid1.resource.oc1..xxxxxxEXAMPLExxxxxx&#x27;, &#x27;inactive_status&#x27;: 56, &#x27;key&#x27;: &#x27;key_example&#x27;, &#x27;lifecycle_state&#x27;: &#x27;CREATING&#x27;, &#x27;time_created&#x27;: &#x27;2013-10-20T19:20:30+01:00&#x27;, &#x27;time_expires&#x27;: &#x27;2013-10-20T19:20:30+01:00&#x27;, &#x27;user_id&#x27;: &#x27;ocid1.user.oc1..xxxxxxEXAMPLExxxxxx&#x27;}</div>
                                    </td>
            </tr>
                                        <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-customer_secret_key/display_name"></div>
                    <b>display_name</b>
                    <a class="ansibleOptionLink" href="#return-customer_secret_key/display_name" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>The display name you assign to the secret key. Does not have to be unique, and it&#x27;s changeable.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-customer_secret_key/id"></div>
                    <b>id</b>
                    <a class="ansibleOptionLink" href="#return-customer_secret_key/id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                <td>on success</td>
                <td>
                                            <div>The access key portion of the key pair.</div>
                                        <br/>
                                                                <div style="font-size: smaller"><b>Sample:</b></div>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-customer_secret_key/inactive_status"></div>
                    <b>inactive_status</b>
                    <a class="ansibleOptionLink" href="#return-customer_secret_key/inactive_status" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">integer</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-customer_secret_key/lifecycle_state"></div>
                    <b>lifecycle_state</b>
                    <a class="ansibleOptionLink" href="#return-customer_secret_key/lifecycle_state" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-customer_secret_key/time_created"></div>
                    <b>time_created</b>
                    <a class="ansibleOptionLink" href="#return-customer_secret_key/time_created" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-customer_secret_key/time_expires"></div>
                    <b>time_expires</b>
                    <a class="ansibleOptionLink" href="#return-customer_secret_key/time_expires" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
                ...
                <td>
                                ...
                                <tr>
                                    <td class="elbow-placeholder">&nbsp;</td>
                                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="return-customer_secret_key/user_id"></div>
                    <b>user_id</b>
                    <a class="ansibleOptionLink" href="#return-customer_secret_key/user_id" title="Permalink to this return value"></a>
                    <div style="font-size: small">
                      <span style="color: purple">string</span>
                                          </div>
                                    </td>
