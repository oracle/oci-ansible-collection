...
.. _ansible_collections.oracle.oci.oci_functions_application_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`oracle.oci.oci_functions_application`.
...
- This resource has the following action operations in the :ref:`oracle.oci.oci_functions_application_actions <ansible_collections.oracle.oci.oci_functions_application_actions_module>` module: change_compartment.
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The OCID of the compartment to create the application within.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">dictionary</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>Application configuration. These values are passed on to the function as environment variables, functions may override application configuration. Keys must be ASCII strings consisting solely of letters, digits, and the &#x27;_&#x27; (underscore) character, and must not begin with a digit. Values should be limited to printable unicode characters.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                            <div>The display name of the application. The display name must be unique within the compartment containing the application. Avoid entering confidential information.</div>
                                            <div>Required for create using <em>state=present</em>.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                         / <span style="color: purple">elements=string</span>                                            </div>
                                ...
                                <tr>
                                                                <td colspan="3">
                    <div class="ansibleOptionAnchor" id="parameter-syslog_url"></div>
                    <b>syslog_url</b>
                    <a class="ansibleOptionLink" href="#parameter-syslog_url" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
                        ...
                        <span style="color: purple">dictionary</span>
                                ...
                                <td>
                                        ...
                                        <tr>
                                                    <td class="elbow-placeholder"></td>
                                                <td colspan="2">
                    <div class="ansibleOptionAnchor" id="parameter-trace_config/domain_id"></div>
                    <b>domain_id</b>
                    <a class="ansibleOptionLink" href="#parameter-trace_config/domain_id" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                                                                    </div>
                                                        </td>
