...
- This resource has the following action operations in the M(oci_managed_instance_group_actions) module: attach_managed_instance, change_compartment, detach_managed_instance, install_all_updates.
