...
htmlhelp_basename = "OracleCloudInfrastructureAnsibleCollectiondoc"
...
latex_documents = [
    (
        master_doc,
        "OracleCloudInfrastructureAnsibleCollection.tex",
...
man_pages = [
    (
        master_doc,
        "oraclecloudinfrastructureansiblecollection",
        "Oracle Cloud Infrastructure Ansible Collection Documentation",
        [author],
        1,
    )
