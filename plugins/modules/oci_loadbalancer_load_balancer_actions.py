...
DOCUMENTATION = """
---
module: oci_loadbalancer_load_balancer_actions
short_description: Perform actions on a LoadBalancer resource in Oracle Cloud Infrastructure
description:
...
options:
    load_balancer_id:
        description:
            - The L(OCID,https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the load balancer to move.
        type: str
        aliases: ["id"]
        required: true
    compartment_id:
        description:
            - The L(OCID,https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to move the load balancer to.
        type: str
        required: true
    action:
        description:
            - The action to perform on the LoadBalancer.
        type: str
        required: true
        choices:
            - "change_compartment"
...
try:
    ...
    from oci.load_balancer.models import ChangeLoadBalancerCompartmentDetails
...
class LoadBalancerActionsHelperGen(OCIActionsHelperBase):
    """
    Supported actions:
        change_compartment
    """
    ...
    def change_compartment(self):
        action_details = oci_common_utils.convert_input_data_to_model_class(
            self.module.params, ChangeLoadBalancerCompartmentDetails
        )
        return oci_wait_utils.call_and_wait(
            call_fn=self.client.change_load_balancer_compartment,
            call_fn_args=(),
            call_fn_kwargs=dict(
                load_balancer_id=self.module.params.get("load_balancer_id"),
                change_load_balancer_compartment_details=action_details,
            ),
...
LoadBalancerActionsHelperCustom = get_custom_class("LoadBalancerActionsHelperCustom")


class ResourceHelper(LoadBalancerActionsHelperCustom, LoadBalancerActionsHelperGen):
    pass
