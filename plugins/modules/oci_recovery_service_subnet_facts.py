...
short_description: Fetches details about one or multiple RecoveryServiceSubnet resources in Oracle Cloud Infrastructure
description:
    ...
    - If I(recovery_service_subnet_id) is specified, the details of a single RecoveryServiceSubnet will be returned.
version_added: "2.9.0"
...
options:
    recovery_service_subnet_id:
        description:
            ...
            - Required to get a specific recovery_service_subnet.
        type: str
        aliases: ["id"]
    compartment_id:
        description:
            - The compartment OCID.
            - Required to list multiple recovery_service_subnets.
        type: str
    lifecycle_state:
        description:
...
recovery_service_subnets:
    description:
        - List of RecoveryServiceSubnet resources
    returned: on success
    type: complex
    contains:
        id:
