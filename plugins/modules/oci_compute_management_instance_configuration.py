                                ...
                                suboptions:
                                    ...
                                    numa_nodes_per_socket:
                                        description:
                                            ...
                                            - Applicable when type is one of ['AMD_MILAN_BM', 'AMD_MILAN_BM_GPU', 'AMD_ROME_BM_GPU', 'INTEL_ICELAKE_BM',
                                              'AMD_ROME_BM']
                                        type: str
                                        choices:
                                            - "NPS0"
                                    ...
                                    is_memory_encryption_enabled:
                                        description:
                                            - Whether the instance is a confidential instance. If this value is `true`, the instance is a confidential instance.
            ...
            instance_details=dict(
                ...
                options=dict(
                            ...
                            launch_details=dict(
                                ...
                                options=dict(
                                    ...
                                    platform_config=dict(
                                        type="dict",
                                        options=dict(
                                            percentage_of_cores_enabled=dict(
                                                type="int"
                                            ),
                                            ...
                                            is_access_control_service_enabled=dict(
                                                type="bool"
                                            ),
                                            are_virtual_instructions_enabled=dict(
                                                type="bool"
                                            ),
                                            ...
                                            is_memory_encryption_enabled=dict(
                                                type="bool"
                                            ),
                                        ),
                                    ),
                                    source_details=dict(
                                        ...
                                        options=dict(
                                            ...
                                            instance_source_image_filter_details=dict(
                                                ...
                                                options=dict(
                                                    compartment_id=dict(type="str"),
                                                    defined_tags_filter=dict(
                                                        type="dict"
                                                    ),
                                                    operating_system=dict(type="str"),
                                                    operating_system_version=dict(
                                                        type="str"
                                                    ),
                                                ),
                                            ),
                                    ...
                                    instance_options=dict(
                                        type="dict",
                                        options=dict(
                                            are_legacy_imds_endpoints_disabled=dict(
                                                type="bool"
                                            )
                                        ),
                                    ),
                                    availability_config=dict(
                                        type="dict",
                                        options=dict(
                                            is_live_migration_preferred=dict(
                                                type="bool"
                                            ),
                    ...
                    instance_type=dict(
                        type="str",
                        default="compute",
                        choices=["instance_options", "compute"],
                    ),
                    block_volumes=dict(
                        type="list",
                        elements="dict",
