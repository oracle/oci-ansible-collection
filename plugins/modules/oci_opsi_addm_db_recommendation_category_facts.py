...
short_description: Fetches details about one or multiple AddmDbRecommendationCategory resources in Oracle Cloud Infrastructure
description:
    - Fetches details about one or multiple AddmDbRecommendationCategory resources in Oracle Cloud Infrastructure
...
EXAMPLES = """
- name: List addm_db_recommendation_categories
  oci_opsi_addm_db_recommendation_category_facts:
    # required
...
RETURN = """
addm_db_recommendation_categories:
    description:
        - List of AddmDbRecommendationCategory resources
    returned: on success
    type: complex
    contains:
        id:
