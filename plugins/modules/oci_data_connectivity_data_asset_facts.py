...
DOCUMENTATION = """
---
module: oci_data_connectivity_data_asset_facts
...
- name: Get a specific data_asset
  oci_data_connectivity_data_asset_facts:
    # required
...
- name: List data_assets
  oci_data_connectivity_data_asset_facts:
    ...
    folder_id: "ocid1.folder.oc1..xxxxxxEXAMPLExxxxxx"
    endpoint_ids: [ "endpoint_ids_example" ]
    exclude_endpoint_ids: [ "exclude_endpoint_ids_example" ]
    ...
    contains:
        ...
        end_points:
            ...
            contains:
                ...
                key:
                    description:
                        - Generated key that can be used in API calls to identify endpoint. On scenarios where reference to the endpoint is needed, a value can
                          be passed in create.
                    returned: on success
                    type: str
                    sample: key_example
...
def main():
    ...
    module_args.update(
        dict(
            ...
            exclude_endpoint_ids=dict(type="list", elements="str"),
        )
    )
