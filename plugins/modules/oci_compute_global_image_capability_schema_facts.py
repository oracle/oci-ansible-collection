...
DOCUMENTATION = """
---
module: oci_compute_global_image_capability_schema_facts
short_description: Fetches details about one or multiple ComputeGlobalImageCapabilitySchema resources in Oracle Cloud Infrastructure
description:
    ...
    - If I(compute_global_image_capability_schema_id) is specified, the details of a single ComputeGlobalImageCapabilitySchema will be returned.
version_added: "2.9"
...
options:
    compute_global_image_capability_schema_id:
        description:
            ...
            - Required to get a specific compute_global_image_capability_schema.
        type: str
        aliases: ["id"]
    compartment_id:
        description:
...
compute_global_image_capability_schemas:
    description:
        - List of ComputeGlobalImageCapabilitySchema resources
    returned: on success
    type: complex
    contains:
        id:
...
class ComputeGlobalImageCapabilitySchemaFactsHelperGen(OCIResourceFactsHelperBase):
    ...
    def get_resource(self):
        return oci_common_utils.call_with_backoff(
            self.client.get_compute_global_image_capability_schema,
    ...
    def list_resources(self):
        ...
        return oci_common_utils.list_all_resources(
            self.client.list_compute_global_image_capability_schemas, **optional_kwargs
        )


ComputeGlobalImageCapabilitySchemaFactsHelperCustom = get_custom_class(
    "ComputeGlobalImageCapabilitySchemaFactsHelperCustom"
)


class ResourceFactsHelper(
    ComputeGlobalImageCapabilitySchemaFactsHelperCustom,
    ComputeGlobalImageCapabilitySchemaFactsHelperGen,
):
    pass
...
def main():
    ...
    module_args.update(
        dict(
            compute_global_image_capability_schema_id=dict(aliases=["id"], type="str"),
    ...
    resource_facts_helper = ResourceFactsHelper(
        module=module,
        resource_type="compute_global_image_capability_schema",
    ...
    module.exit_json(compute_global_image_capability_schemas=result)
