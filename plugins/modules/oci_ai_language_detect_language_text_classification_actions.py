...
description:
    ...
    - "For I(action=detect_language_text_classification), this API will be retired on Monday, 10 Oct 2023 00:00:00 GMT
      The API automatically classifies text into a set of pre-determined classes and sub-classes. A single class/subclass is returned for each record
      classified.
