...
DOCUMENTATION = """
---
module: oci_mysql_analytics_cluster_facts
...
class MysqlAnalyticsClusterFactsHelperGen(OCIResourceFactsHelperBase):
...
MysqlAnalyticsClusterFactsHelperCustom = get_custom_class(
    "MysqlAnalyticsClusterFactsHelperCustom"
)


class ResourceFactsHelper(
    MysqlAnalyticsClusterFactsHelperCustom, MysqlAnalyticsClusterFactsHelperGen
):
    pass
...
def main():
    ...
    module.exit_json(analytics_cluster=result)
