...
short_description: Manage a Rrset resource in Oracle Cloud Infrastructure
description:
...
options:
    ...
    state:
        description:
            ...
            - Use I(state=present) to update an existing a Rrset.
            - Use I(state=absent) to delete a Rrset.
        type: str
        required: false
        default: 'present'
...
try:
    ...
    from oci.dns.models import UpdateRRSetDetails
    from oci.dns.models import PatchRRSetDetails
...
class ResourceHelper(RrsetHelperCustom, RrsetHelperGen):
    pass
