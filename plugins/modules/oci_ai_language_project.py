...
description:
    ...
    - "This resource has the following action operations in the M(oracle.oci.oci_ai_language_project_actions) module: change_compartment."
version_added: "2.9.0"
author: Oracle (@oracle)
options:
    compartment_id:
        description:
            - The L(OCID,https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) for the project's compartment.
