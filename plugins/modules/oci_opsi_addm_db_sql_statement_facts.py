...
short_description: Fetches details about one or multiple AddmDbSqlStatement resources in Oracle Cloud Infrastructure
description:
...
RETURN = """
addm_db_sql_statements:
    description:
        - List of AddmDbSqlStatement resources
    returned: on success
    type: complex
    contains:
        id:
