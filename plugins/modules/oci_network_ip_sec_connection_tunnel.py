...
options:
    ...
    dpd_config:
        ...
        suboptions:
            ...
            dpd_timeout_in_sec:
                description:
                    - DPD timeout in seconds. This sets the longest interval between CPE device health messages before the IPSec connection indicates it has
                      lost contact with the CPE. The default is 20 seconds.
                    - This parameter is updatable.
                type: int
...
class IpSecConnectionTunnelHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(
            IpSecConnectionTunnelHelperGen, self
        ).get_possible_entity_types() + [
            "ipsecconnectiontunnel",
            "ipsecconnectiontunnels",
            "coreipsecconnectiontunnel",
            "coreipsecconnectiontunnels",
            "ipsecconnectiontunnelresource",
            "ipsecconnectiontunnelsresource",
            "tunnel",
            "tunnels",
            "coretunnel",
            "coretunnels",
