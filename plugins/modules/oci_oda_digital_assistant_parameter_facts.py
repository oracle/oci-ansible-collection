...
short_description: Fetches details about one or multiple DigitalAssistantParameter resources in Oracle Cloud Infrastructure
description:
    - Fetches details about one or multiple DigitalAssistantParameter resources in Oracle Cloud Infrastructure
    - Returns a page of Parameters that belong to the specified Digital Assistant.
    - If the `opc-next-page` header appears in the response, then
      there are more items to retrieve. To get the next page in the subsequent
      GET request, include the header's value as the `page` query parameter.
    - If I(parameter_name) is specified, the details of a single DigitalAssistantParameter will be returned.
version_added: "2.9.0"
...
options:
    parameter_name:
        description:
            ...
            - Required to get a specific digital_assistant_parameter.
        type: str
    oda_instance_id:
        description:
...
EXAMPLES = """
- name: Get a specific digital_assistant_parameter
  oci_oda_digital_assistant_parameter_facts:
    # required
...
- name: List digital_assistant_parameters
  oci_oda_digital_assistant_parameter_facts:
    # required
    oda_instance_id: "ocid1.odainstance.oc1..xxxxxxEXAMPLExxxxxx"
    digital_assistant_id: "ocid1.digitalassistant.oc1..xxxxxxEXAMPLExxxxxx"
...
RETURN = """
digital_assistant_parameters:
    description:
        - List of DigitalAssistantParameter resources
    returned: on success
    type: complex
    contains:
        name:
