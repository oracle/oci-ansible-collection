...
DOCUMENTATION = """
---
module: oci_database_maintenance_run_history_facts
short_description: Fetches details about one or multiple MaintenanceRunHistory resources in Oracle Cloud Infrastructure
description:
    ...
    - If I(maintenance_run_history_id) is specified, the details of a single MaintenanceRunHistory will be returned.
version_added: "2.9.0"
...
options:
    maintenance_run_history_id:
        description:
            ...
            - Required to get a specific maintenance_run_history.
        type: str
        aliases: ["id"]
    compartment_id:
        description:
            - The compartment L(OCID,https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).
            - Required to list multiple maintenance_run_histories.
        type: str
    target_resource_id:
        description:
...
maintenance_run_histories:
    description:
        - List of MaintenanceRunHistory resources
    returned: on success
    type: complex
    contains:
        id:
        ...
        maintenance_run_details:
            ...
            contains:
                ...
                lifecycle_state:
                    description:
                        - The current state of the maintenance run. For Autonomous Database Serverless instances, valid states are IN_PROGRESS, SUCCEEDED, and
                          FAILED.
                    returned: on success
                    type: str
                    sample: SCHEDULED
                ...
                patch_id:
                    description:
                        - The unique identifier of the patch. The identifier string includes the patch type, the Oracle Database version, and the patch creation
                          date (using the format YYMMDD). For example, the identifier `ru_patch_19.9.0.0_201030` is used for an RU patch for Oracle Database
                ...
                peer_maintenance_run_id:
                    description:
                        - The L(OCID,https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the maintenance run for the Autonomous Data
                          Guard association's peer container database.
                    returned: on success
                    type: str
...
class MaintenanceRunHistoryFactsHelperGen(OCIResourceFactsHelperBase):
    ...
    def get_resource(self):
        return oci_common_utils.call_with_backoff(
            self.client.get_maintenance_run_history,
            maintenance_run_history_id=self.module.params.get(
                "maintenance_run_history_id"
            ),
        )
    ...
    def list_resources(self):
        ...
        return oci_common_utils.list_all_resources(
            self.client.list_maintenance_run_history,
            compartment_id=self.module.params.get("compartment_id"),
            **optional_kwargs
        )


MaintenanceRunHistoryFactsHelperCustom = get_custom_class(
    "MaintenanceRunHistoryFactsHelperCustom"
)


class ResourceFactsHelper(
    MaintenanceRunHistoryFactsHelperCustom, MaintenanceRunHistoryFactsHelperGen
):
    pass
...
def main():
    ...
    module_args.update(
        dict(
            maintenance_run_history_id=dict(aliases=["id"], type="str"),
    ...
    resource_facts_helper = ResourceFactsHelper(
        module=module,
        resource_type="maintenance_run_history",
    ...
    module.exit_json(maintenance_run_histories=result)
