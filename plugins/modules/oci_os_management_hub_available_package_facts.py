...
class OsManagementHubAvailablePackageFactsHelperGen(OCIResourceFactsHelperBase):
...
OsManagementHubAvailablePackageFactsHelperCustom = get_custom_class(
    "OsManagementHubAvailablePackageFactsHelperCustom"
)


class ResourceFactsHelper(
    OsManagementHubAvailablePackageFactsHelperCustom,
    OsManagementHubAvailablePackageFactsHelperGen,
):
    pass
