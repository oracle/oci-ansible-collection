...
short_description: Fetches details about one or multiple AlertPolicy resources in Oracle Cloud Infrastructure
description:
    ...
    - If I(alert_policy_id) is specified, the details of a single AlertPolicy will be returned.
version_added: "2.9.0"
