...
short_description: Fetches details about one or multiple Pipeline resources in Oracle Cloud Infrastructure
description:
    - Fetches details about one or multiple Pipeline resources in Oracle Cloud Infrastructure
    - Returns a list of Pipelines.
    - If I(pipeline_id) is specified, the details of a single Pipeline will be returned.
version_added: "2.9.0"
