...
DOCUMENTATION = """
---
module: oci_database_management_alert_log_counts_facts
short_description: Fetches details about one or multiple AlertLogCounts resources in Oracle Cloud Infrastructure
description:
...
alert_log_counts:
    description:
        - List of AlertLogCounts resources
    returned: on success
    type: complex
    contains:
        category:
...
class AlertLogCountsFactsHelperGen(OCIResourceFactsHelperBase):
    ...
    def list_resources(self):
        ...
        return oci_common_utils.list_all_resources(
            self.client.summarize_alert_log_counts,
            managed_database_id=self.module.params.get("managed_database_id"),
            **optional_kwargs
        )


AlertLogCountsFactsHelperCustom = get_custom_class("AlertLogCountsFactsHelperCustom")


class ResourceFactsHelper(
    AlertLogCountsFactsHelperCustom, AlertLogCountsFactsHelperGen
):
    pass
...
def main():
    ...
    module_args.update(
        dict(
            ...
            group_by=dict(type="str", choices=["LEVEL", "TYPE"]),
            type_filter=dict(
                type="str",
                choices=[
                    "UNKNOWN",
    ...
    resource_facts_helper = ResourceFactsHelper(
        module=module,
        resource_type="alert_log_counts",
    ...
    module.exit_json(alert_log_counts=result)
