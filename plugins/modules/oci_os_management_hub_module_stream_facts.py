...
class OsManagementHubModuleStreamFactsHelperGen(OCIResourceFactsHelperBase):
...
OsManagementHubModuleStreamFactsHelperCustom = get_custom_class(
    "OsManagementHubModuleStreamFactsHelperCustom"
)


class ResourceFactsHelper(
    OsManagementHubModuleStreamFactsHelperCustom,
    OsManagementHubModuleStreamFactsHelperGen,
):
    pass
