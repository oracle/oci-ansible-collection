...
DOCUMENTATION = """
---
module: oci_identity_user_capabilities
...
options:
    ...
    state:
        description:
            - The state of the UserCapabilities.
            - Use I(state=present) to update an existing an UserCapabilities.
        type: str
        required: false
        default: 'present'
        choices: ["present"]
...
user:
    description:
        - Details of the UserCapabilities resource acted upon by the current operation
    returned: on success
    type: complex
    contains:
        id:
...
try:
    ...
    from oci.identity.models import UpdateUserCapabilitiesDetails
...
class UserCapabilitiesHelperGen(OCIResourceHelperBase):
    ...
    def update_resource(self):
        ...
        return oci_wait_utils.call_and_wait(
            call_fn=self.client.update_user_capabilities,
            call_fn_args=(),
            call_fn_kwargs=dict(
...
UserCapabilitiesHelperCustom = get_custom_class("UserCapabilitiesHelperCustom")


class ResourceHelper(UserCapabilitiesHelperCustom, UserCapabilitiesHelperGen):
    pass
...
def main():
    ...
    resource_helper = ResourceHelper(
        module=module,
        resource_type="user_capabilities",
