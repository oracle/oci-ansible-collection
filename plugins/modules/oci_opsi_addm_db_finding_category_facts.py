...
short_description: Fetches details about one or multiple AddmDbFindingCategory resources in Oracle Cloud Infrastructure
description:
...
RETURN = """
addm_db_finding_categories:
    description:
        - List of AddmDbFindingCategory resources
    returned: on success
    type: complex
    contains:
        id:
