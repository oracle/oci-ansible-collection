...
DOCUMENTATION = """
---
module: oci_database_management_proxy_user_facts
...
class ProxyUserFactsHelperGen(OCIResourceFactsHelperBase):
...
ProxyUserFactsHelperCustom = get_custom_class("ProxyUserFactsHelperCustom")


class ResourceFactsHelper(ProxyUserFactsHelperCustom, ProxyUserFactsHelperGen):
    pass
...
def main():
    ...
    module.exit_json(proxy_users=result)
