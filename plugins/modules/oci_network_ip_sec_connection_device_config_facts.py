...
description:
    ...
    - "* L(GetIPSecConnectionTunnel,https://docs.cloud.oracle.com/#/en/iaas/20160918/IPSecConnectionTunnel/GetIPSecConnectionTunnel)
      * L(GetIPSecConnectionTunnelSharedSecret,https://docs.cloud.oracle.com/#/en/iaas/20160918/IPSecConnectionTunnelSharedSecret/GetIPSecConnectionTunnelShared
      Secret)"
version_added: "2.9"
...
ip_sec_connection_device_config:
    ...
    contains:
        ...
        tunnels:
            description:
                - Two L(TunnelConfig,https://docs.cloud.oracle.com/#/en/iaas/20160918/TunnelConfig/) objects.
            returned: on success
            type: complex
            contains:
                ip_address:
