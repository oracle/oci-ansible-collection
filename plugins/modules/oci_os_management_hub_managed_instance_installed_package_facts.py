...
class ManagedInstanceInstalledPackageFactsHelperGen(OCIResourceFactsHelperBase):
...
ManagedInstanceInstalledPackageFactsHelperCustom = get_custom_class(
    "ManagedInstanceInstalledPackageFactsHelperCustom"
)


class ResourceFactsHelper(
    ManagedInstanceInstalledPackageFactsHelperCustom,
    ManagedInstanceInstalledPackageFactsHelperGen,
):
    pass
