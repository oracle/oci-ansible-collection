...
class OsManagementHubLifecycleEnvironmentHelperGen(OCIResourceHelperBase):
    """Supported operations: create, update, get, list and delete"""

    def get_possible_entity_types(self):
        return super(
            OsManagementHubLifecycleEnvironmentHelperGen, self
...
OsManagementHubLifecycleEnvironmentHelperCustom = get_custom_class(
    "OsManagementHubLifecycleEnvironmentHelperCustom"
)


class ResourceHelper(
    OsManagementHubLifecycleEnvironmentHelperCustom,
    OsManagementHubLifecycleEnvironmentHelperGen,
):
    pass
