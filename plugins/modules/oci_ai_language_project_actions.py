...
description:
    ...
    - For I(action=change_compartment), moves a Project into a different compartment. When provided, If-Match is checked against ETag values of the resource.
version_added: "2.9.0"
...
- name: Perform action change_compartment on project
  oci_ai_language_project_actions:
    # required
