...
class ComputeCapacityReservationHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(
            ComputeCapacityReservationHelperGen, self
        ).get_possible_entity_types() + [
            "capacityreservation",
            "capacityreservations",
            "corecapacityreservation",
            "corecapacityreservations",
            "capacityreservationresource",
            "capacityreservationsresource",
            "computecapacityreservation",
            "computecapacityreservations",
            "corecomputecapacityreservation",
            "corecomputecapacityreservations",
            "computecapacityreservationresource",
            "computecapacityreservationsresource",
            "core",
        ]
    ...
    def get_get_model_from_summary_model(self, summary_model):
        return oci_common_utils.call_with_backoff(
            ...
            capacity_reservation_id=summary_model.id,
        ).data
