...
DOCUMENTATION = """
---
module: oci_data_connectivity_data_asset
...
description:
    ...
    - For I(state=present), creates a data asset with default connection.
version_added: "2.9.0"
...
options:
    ...
    properties:
        description:
            ...
            - Required for create using I(state=present), update using I(state=present) with data_asset_key present.
        type: dict
    type:
        description:
                                        ...
                                        suboptions:
                                            ...
                                            elements:
                                                ...
                                                suboptions:
                                                    labels:
                                                        description:
                                                            - Labels are keywords or labels that you can add to data assets, dataflows etc. You can define your
    ...
    end_points:
        ...
        suboptions:
            ...
            key:
                description:
                    - Generated key that can be used in API calls to identify endpoint. On scenarios where reference to the endpoint is needed, a value can be
                      passed in create.
                type: str
            model_version:
                description:
                ...
                suboptions:
                                                        ...
                                                        suboptions:
                                                            ...
                                                            elements:
                                                                ...
                                                                suboptions:
                                                                    labels:
                                                                        description:
                                                                            - Labels are keywords or labels that you can add to data assets, dataflows etc. You
                    ...
                    default_connection:
                        ...
                        suboptions:
                            key:
                                description:
                                    - Generated key that can be used in API calls to identify connection. On scenarios where reference to the connection is
                    ...
                    end_points:
                        ...
                        suboptions:
                            ...
                            key:
                                description:
                                    - Generated key that can be used in API calls to identify endpoint. On scenarios where reference to the endpoint is needed,
...
- name: Create data_asset
  oci_data_connectivity_data_asset:
    # required
    name: name_example
...
try:
    ...
    from oci.data_connectivity.models import CreateDataAssetDetails
    from oci.data_connectivity.models import UpdateDataAssetDetails
...
class DataAssetHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(DataAssetHelperGen, self).get_possible_entity_types() + [
            "dataasset",
            "dataassets",
            "dataConnectivitydataasset",
            "dataConnectivitydataassets",
            "dataassetresource",
            "dataassetsresource",
            "dataconnectivity",
        ]
                        ...
                        options=dict(
                            ...
                            end_points=dict(
                                ...
                                options=dict(
                                    ...
                                    object_status=dict(type="int"),
                                    identifier=dict(type="str"),
                                    data_assets=dict(type="list", elements="dict"),
                                ),
                            ),
                        ),
                    ),
