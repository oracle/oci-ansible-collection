...
DOCUMENTATION = """
---
module: oci_network_load_balancer_network_load_balancing_policy_facts
short_description: Fetches details about one or multiple NetworkLoadBalancingPolicy resources in Oracle Cloud Infrastructure
description:
...
RETURN = """
network_load_balancing_policies:
    description:
        - List of NetworkLoadBalancingPolicy resources
    returned: on success
    type: complex
    contains:
        items:
...
class NetworkLoadBalancerNetworkLoadBalancingPolicyFactsHelperGen(
    OCIResourceFactsHelperBase
):
    ...
    def list_resources(self):
        ...
        return oci_common_utils.list_all_resources(
            self.client.list_network_load_balancers_policies, **optional_kwargs
        )


NetworkLoadBalancerNetworkLoadBalancingPolicyFactsHelperCustom = get_custom_class(
    "NetworkLoadBalancerNetworkLoadBalancingPolicyFactsHelperCustom"
)


class ResourceFactsHelper(
    NetworkLoadBalancerNetworkLoadBalancingPolicyFactsHelperCustom,
    NetworkLoadBalancerNetworkLoadBalancingPolicyFactsHelperGen,
):
    pass
...
def main():
    ...
    resource_facts_helper = ResourceFactsHelper(
        module=module,
        resource_type="network_load_balancing_policy",
    ...
    module.exit_json(network_load_balancing_policies=result)
