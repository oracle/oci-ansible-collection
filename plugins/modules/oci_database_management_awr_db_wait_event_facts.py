...
DOCUMENTATION = """
---
module: oci_database_management_awr_db_wait_event_facts
short_description: Fetches details about a AwrDbWaitEvent resource in Oracle Cloud Infrastructure
description:
...
class AwrDbWaitEventFactsHelperGen(OCIResourceFactsHelperBase):
    ...
    def get_resource(self):
        ...
        return oci_common_utils.call_with_backoff(
            self.client.summarize_awr_db_wait_events,
...
AwrDbWaitEventFactsHelperCustom = get_custom_class("AwrDbWaitEventFactsHelperCustom")


class ResourceFactsHelper(
    AwrDbWaitEventFactsHelperCustom, AwrDbWaitEventFactsHelperGen
):
    pass
