...
short_description: Manage a RoverNode resource in Oracle Cloud Infrastructure
description:
    - This module allows the user to create, update and delete a RoverNode resource in Oracle Cloud Infrastructure
    - For I(state=present), creates a new RoverNode.
    - "This resource has the following action operations in the M(oracle.oci.oci_rover_node_actions) module: change_compartment."
version_added: "2.9.0"
...
options:
    ...
    state:
        description:
            ...
            - Use I(state=present) to create or update a RoverNode.
            - Use I(state=absent) to delete a RoverNode.
        type: str
        required: false
        default: 'present'
