...
short_description: Fetches details about a HostInsightResourceCapacityTrend resource in Oracle Cloud Infrastructure
description:
...
RETURN = """
host_insight_resource_capacity_trend:
    description:
        - HostInsightResourceCapacityTrend resource
    returned: on success
    type: complex
    contains:
        time_interval_start:
