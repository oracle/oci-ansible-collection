...
DOCUMENTATION = """
---
module: oci_database_db_home_patch_facts
short_description: Fetches details about one or multiple DbHomePatch resources in Oracle Cloud Infrastructure
description:
...
class DbHomePatchFactsHelperGen(OCIResourceFactsHelperBase):
    ...
    def list_resources(self):
        ...
        return oci_common_utils.list_all_resources(
            self.client.list_db_home_patches,
            db_home_id=self.module.params.get("db_home_id"),
            **optional_kwargs
        )


DbHomePatchFactsHelperCustom = get_custom_class("DbHomePatchFactsHelperCustom")


class ResourceFactsHelper(DbHomePatchFactsHelperCustom, DbHomePatchFactsHelperGen):
    pass
...
def main():
    ...
    module.exit_json(db_home_patches=result)
