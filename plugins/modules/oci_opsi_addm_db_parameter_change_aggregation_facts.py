...
short_description: Fetches details about one or multiple AddmDbParameterChangeAggregation resources in Oracle Cloud Infrastructure
description:
...
RETURN = """
addm_db_parameter_change_aggregations:
    description:
        - List of AddmDbParameterChangeAggregation resources
    returned: on success
    type: complex
    contains:
        id:
