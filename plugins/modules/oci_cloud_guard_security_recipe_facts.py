...
short_description: Fetches details about one or multiple SecurityRecipe resources in Oracle Cloud Infrastructure
description:
    - Fetches details about one or multiple SecurityRecipe resources in Oracle Cloud Infrastructure
    - Gets a list of all security zone recipes in a compartment.
    - If I(security_recipe_id) is specified, the details of a single SecurityRecipe will be returned.
version_added: "2.9.0"
...
options:
    security_recipe_id:
        description:
            ...
            - Required to get a specific security_recipe.
        type: str
        aliases: ["id"]
    compartment_id:
        description:
            - The ID of the compartment in which to list resources.
            - Required to list multiple security_recipes.
        type: str
    lifecycle_state:
        description:
...
EXAMPLES = """
- name: Get a specific security_recipe
  oci_cloud_guard_security_recipe_facts:
    # required
    security_recipe_id: "ocid1.securityrecipe.oc1..xxxxxxEXAMPLExxxxxx"

- name: List security_recipes
  oci_cloud_guard_security_recipe_facts:
    # required
...
security_recipes:
    description:
        - List of SecurityRecipe resources
    returned: on success
    type: complex
    contains:
        id:
