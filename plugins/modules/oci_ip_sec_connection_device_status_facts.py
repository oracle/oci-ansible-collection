...
DOCUMENTATION = """
---
module: oci_ip_sec_connection_device_status_facts
short_description: Retrieve status of the specified IPSec connection
description:
    - This module retrieves status of the specified IPSec connection (whether it's up or down).
version_added: "2.5"
options:
    ipsc_id:
...
EXAMPLES = """
- name: Get status of IPSec connection
  oci_ip_sec_connection_device_status_facts:
    ipsc_id: ocid1.ipsecconnection.oc1.phx.xxxxxEXAMPLExxxxx
"""

RETURN = """
ip_sec_connection_device_status:
    description: IPSec connection's status
    returned: always
    type: complex
    contains:
        compartment_id:
        ...
        tunnels:
            description: Two TunnelStatus objects.
            returned: always
            type: list
    sample: {
            ...
            "tunnels": [{"ip_address": "129.213.7.49",
                         ...
                         "time_created": "2018-09-13T20:22:40.626000+00:00",
                         "time_state_modified": "2018-09-13T20:22:40.626000+00:00"},
