...
DOCUMENTATION = """
---
module: oci_database_db_system_patch_history_entry_facts
short_description: Fetches details about one or multiple DbSystemPatchHistoryEntry resources in Oracle Cloud Infrastructure
description:
...
db_system_patch_history_entries:
    description:
        - List of DbSystemPatchHistoryEntry resources
    returned: on success
    type: complex
    contains:
        id:
...
class DbSystemPatchHistoryEntryFactsHelperGen(OCIResourceFactsHelperBase):
    ...
    def get_resource(self):
        return oci_common_utils.call_with_backoff(
            self.client.get_db_system_patch_history_entry,
    ...
    def list_resources(self):
        ...
        return oci_common_utils.list_all_resources(
            self.client.list_db_system_patch_history_entries,
            db_system_id=self.module.params.get("db_system_id"),
            **optional_kwargs
        )


DbSystemPatchHistoryEntryFactsHelperCustom = get_custom_class(
    "DbSystemPatchHistoryEntryFactsHelperCustom"
)


class ResourceFactsHelper(
    DbSystemPatchHistoryEntryFactsHelperCustom, DbSystemPatchHistoryEntryFactsHelperGen
):
    pass
...
def main():
    ...
    resource_facts_helper = ResourceFactsHelper(
        module=module,
        resource_type="db_system_patch_history_entry",
    ...
    module.exit_json(db_system_patch_history_entries=result)
