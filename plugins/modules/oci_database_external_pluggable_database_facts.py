...
DOCUMENTATION = """
---
module: oci_database_external_pluggable_database_facts
short_description: Fetches details about one or multiple ExternalPluggableDatabase resources in Oracle Cloud Infrastructure
description:
    - Fetches details about one or multiple ExternalPluggableDatabase resources in Oracle Cloud Infrastructure
    - Gets a list of the L(ExternalPluggableDatabase,https://docs.cloud.oracle.com/en-
      us/iaas/api/#/en/database/latest/datatypes/CreateExternalPluggableDatabaseDetails)
      resources in the specified compartment.
    - If I(external_pluggable_database_id) is specified, the details of a single ExternalPluggableDatabase will be returned.
version_added: "2.9"
...
class ExternalPluggableDatabaseFactsHelperGen(OCIResourceFactsHelperBase):
    ...
    def list_resources(self):
        ...
        return oci_common_utils.list_all_resources(
            self.client.list_external_pluggable_databases,
            compartment_id=self.module.params.get("compartment_id"),
            **optional_kwargs
        )


ExternalPluggableDatabaseFactsHelperCustom = get_custom_class(
    "ExternalPluggableDatabaseFactsHelperCustom"
)


class ResourceFactsHelper(
    ExternalPluggableDatabaseFactsHelperCustom, ExternalPluggableDatabaseFactsHelperGen
):
    pass
...
def main():
    ...
    module.exit_json(external_pluggable_databases=result)
