...
DOCUMENTATION = """
---
module: oci_dns_zone_records
short_description: Manage a ZoneRecords resource in Oracle Cloud Infrastructure
description:
...
try:
    ...
    from oci.dns.models import UpdateZoneRecordsDetails
    from oci.dns.models import PatchZoneRecordsDetails
...
ZoneRecordsHelperCustom = get_custom_class("ZoneRecordsHelperCustom")


class ResourceHelper(ZoneRecordsHelperCustom, ZoneRecordsHelperGen):
    pass
