...
DOCUMENTATION = """
---
module: oci_blockstorage_boot_volume_replica_facts
short_description: Fetches details about one or multiple BootVolumeReplica resources in Oracle Cloud Infrastructure
description:
    ...
    - If I(boot_volume_replica_id) is specified, the details of a single BootVolumeReplica will be returned.
version_added: "2.9.0"
...
options:
    boot_volume_replica_id:
        description:
            ...
            - Required to get a specific boot_volume_replica.
        type: str
        aliases: ["id"]
    availability_domain:
        description:
...
boot_volume_replicas:
    description:
        - List of BootVolumeReplica resources
    returned: on success
    type: complex
    contains:
        availability_domain:
...
class BootVolumeReplicaFactsHelperGen(OCIResourceFactsHelperBase):
    ...
    def get_resource(self):
        return oci_common_utils.call_with_backoff(
            self.client.get_boot_volume_replica,
            boot_volume_replica_id=self.module.params.get("boot_volume_replica_id"),
        )
...
BootVolumeReplicaFactsHelperCustom = get_custom_class(
    "BootVolumeReplicaFactsHelperCustom"
)


class ResourceFactsHelper(
    BootVolumeReplicaFactsHelperCustom, BootVolumeReplicaFactsHelperGen
):
    pass
...
def main():
    ...
    resource_facts_helper = ResourceFactsHelper(
        module=module,
        resource_type="boot_volume_replica",
    ...
    module.exit_json(boot_volume_replicas=result)
