...
short_description: Fetches details about one or multiple AddmDbFindingsTimeSeries resources in Oracle Cloud Infrastructure
description:
...
RETURN = """
addm_db_findings_time_series:
    description:
        - List of AddmDbFindingsTimeSeries resources
    returned: on success
    type: complex
    contains:
        id:
