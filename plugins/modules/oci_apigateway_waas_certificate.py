...
DOCUMENTATION = """
---
module: oci_apigateway_waas_certificate
...
class ApigatewayWaasCertificateHelperGen(OCIResourceHelperBase):
...
ApigatewayWaasCertificateHelperCustom = get_custom_class(
    "ApigatewayWaasCertificateHelperCustom"
)


class ResourceHelper(
    ApigatewayWaasCertificateHelperCustom, ApigatewayWaasCertificateHelperGen
):
    pass
