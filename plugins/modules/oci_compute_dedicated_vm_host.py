...
class DedicatedVmHostHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(DedicatedVmHostHelperGen, self).get_possible_entity_types() + [
            "dedicatedvmhost",
            "dedicatedvmhosts",
            "corededicatedvmhost",
            "corededicatedvmhosts",
            "dedicatedvmhostresource",
            "dedicatedvmhostsresource",
            "core",
        ]
    ...
    def get_get_model_from_summary_model(self, summary_model):
        return oci_common_utils.call_with_backoff(
            self.client.get_dedicated_vm_host, dedicated_vm_host_id=summary_model.id,
        ).data
