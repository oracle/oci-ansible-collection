...
short_description: Fetches details about one or multiple AwrDatabase resources in Oracle Cloud Infrastructure
description:
    - Fetches details about one or multiple AwrDatabase resources in Oracle Cloud Infrastructure
...
EXAMPLES = """
- name: List awr_databases
  oci_opsi_awr_database_facts:
    # required
