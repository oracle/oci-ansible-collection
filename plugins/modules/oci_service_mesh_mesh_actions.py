...
short_description: Perform actions on a Mesh resource in Oracle Cloud Infrastructure
description:
    - Perform actions on a Mesh resource in Oracle Cloud Infrastructure
    - For I(action=change_compartment), moves a Mesh resource from one compartment identifier to another. When provided, If-Match is checked against ETag values
      of the resource.
version_added: "2.9.0"
...
options:
    ...
    action:
        description:
            - The action to perform on the Mesh.
        type: str
        required: true
        choices:
            - "change_compartment"
