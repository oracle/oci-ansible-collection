...
class CloudVmClusterIormConfigHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(
            CloudVmClusterIormConfigHelperGen, self
        ).get_possible_entity_types() + [
            "cloudvmclusteriormconfig",
            "cloudvmclusteriormconfigs",
            "databasecloudvmclusteriormconfig",
            "databasecloudvmclusteriormconfigs",
            "cloudvmclusteriormconfigresource",
            "cloudvmclusteriormconfigsresource",
            "database",
        ]
