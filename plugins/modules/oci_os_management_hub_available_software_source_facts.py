...
description:
    ...
    - Returns a list of software sources that can be attached to the specified managed instance. Any software sources already attached to the instance are not
...
class OsManagementHubAvailableSoftwareSourceFactsHelperGen(OCIResourceFactsHelperBase):
...
OsManagementHubAvailableSoftwareSourceFactsHelperCustom = get_custom_class(
    "OsManagementHubAvailableSoftwareSourceFactsHelperCustom"
)


class ResourceFactsHelper(
    OsManagementHubAvailableSoftwareSourceFactsHelperCustom,
    OsManagementHubAvailableSoftwareSourceFactsHelperGen,
):
    pass
