...
short_description: Fetches details about one or multiple DigitalAssistant resources in Oracle Cloud Infrastructure
description:
    ...
    - If I(digital_assistant_id) is specified, the details of a single DigitalAssistant will be returned.
version_added: "2.9.0"
