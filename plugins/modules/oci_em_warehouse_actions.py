...
short_description: Perform actions on an EmWarehouse resource in Oracle Cloud Infrastructure
description:
    - Perform actions on an EmWarehouse resource in Oracle Cloud Infrastructure
    - For I(action=change_compartment), moves a EmWarehouse resource from one compartment identifier to another. When provided, If-Match is checked against ETag
...
options:
    ...
    action:
        description:
            - The action to perform on the EmWarehouse.
        type: str
        required: true
        choices:
            - "change_compartment"
