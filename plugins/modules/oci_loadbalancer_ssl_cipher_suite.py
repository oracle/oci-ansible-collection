...
options:
    ciphers:
        description:
            ...
            - "This module passes the requested cipher names to the OCI Load Balancer service. Use TLSv1.2 or newer AES-GCM cipher suites where possible."
        ...
        ciphers:
            description:
                ...
                - "       \\"AES128-GCM-SHA256\\"
                          ...
                          \\"ECDHE-RSA-AES256-GCM-SHA384\\"
                          \\"ECDHE-RSA-AES256-SHA384\\""
                - "This module returns cipher names from the OCI Load Balancer service. Prefer TLSv1.2 or newer AES-GCM cipher suites when configuring new cipher suites."
                - "example: `[\\"ECDHE-RSA-AES256-GCM-SHA384\\",\\"ECDHE-ECDSA-AES256-GCM-SHA384\\",\\"ECDHE-RSA-AES128-GCM-SHA256\\"]`"
            returned: on success
            type: list
            sample: []
...
class SslCipherSuiteHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(SslCipherSuiteHelperGen, self).get_possible_entity_types() + [
            "sslciphersuite",
            "sslciphersuites",
            "loadBalancersslciphersuite",
            "loadBalancersslciphersuites",
            "sslciphersuiteresource",
            "sslciphersuitesresource",
            "loadbalancer",
        ]
