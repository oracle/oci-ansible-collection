...
short_description: Fetches details about one or multiple WebAppAcceleration resources in Oracle Cloud Infrastructure
description:
    ...
    - If I(web_app_acceleration_id) is specified, the details of a single WebAppAcceleration will be returned.
version_added: "2.9.0"
...
options:
    web_app_acceleration_id:
        description:
            ...
            - Required to get a specific web_app_acceleration.
        type: str
        aliases: ["id"]
    compartment_id:
        description:
            ...
            - Required to list multiple web_app_accelerations.
        type: str
    web_app_acceleration_policy_id:
        description:
            - A filter to return only the WebAppAcceleration with the given
              L(OCID,https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of related WebAppAccelerationPolicy.
        type: str
    lifecycle_state:
        description:
...
web_app_accelerations:
    description:
        - List of WebAppAcceleration resources
    returned: on success
    type: complex
    contains:
        load_balancer_id:
