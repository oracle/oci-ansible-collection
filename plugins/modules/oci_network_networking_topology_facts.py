...
DOCUMENTATION = """
---
module: oci_network_networking_topology_facts
short_description: Fetches details about a NetworkingTopology resource in Oracle Cloud Infrastructure
description:
    - Fetches details about a NetworkingTopology resource in Oracle Cloud Infrastructure
...
class NetworkingTopologyFactsHelperGen(OCIResourceFactsHelperBase):
    ...
    def get_resource(self):
        ...
        return oci_common_utils.call_with_backoff(
            self.client.get_networking_topology,
            compartment_id=self.module.params.get("compartment_id"),
            **optional_kwargs
        )


NetworkingTopologyFactsHelperCustom = get_custom_class(
    "NetworkingTopologyFactsHelperCustom"
)


class ResourceFactsHelper(
    NetworkingTopologyFactsHelperCustom, NetworkingTopologyFactsHelperGen
):
    pass
...
def main():
    ...
    resource_facts_helper = ResourceFactsHelper(
        module=module,
        resource_type="networking_topology",
    ...
    module.exit_json(networking_topology=result)
