...
DOCUMENTATION = """
---
module: oci_data_connectivity_connection_validation_facts
short_description: Fetches details about one or multiple ConnectionValidation resources in Oracle Cloud Infrastructure
description:
    ...
    - If I(connection_validation_key) is specified, the details of a single ConnectionValidation will be returned.
version_added: "2.9.0"
...
options:
    connection_validation_key:
        description:
            ...
            - Required to get a specific connection_validation.
        type: str
    registry_id:
        description:
            - The registry Ocid.
...
connection_validations:
    description:
        - List of ConnectionValidation resources
    returned: on success
    type: complex
    contains:
        validation_message:
...
class ConnectionValidationFactsHelperGen(OCIResourceFactsHelperBase):
    ...
    def list_resources(self):
        ...
        return oci_common_utils.list_all_resources(
            self.client.list_connection_validations,
            registry_id=self.module.params.get("registry_id"),
            **optional_kwargs
        )


ConnectionValidationFactsHelperCustom = get_custom_class(
    "ConnectionValidationFactsHelperCustom"
)


class ResourceFactsHelper(
    ConnectionValidationFactsHelperCustom, ConnectionValidationFactsHelperGen
):
    pass
...
def main():
    ...
    module.exit_json(connection_validations=result)
