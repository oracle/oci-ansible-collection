...
class OsManagementHubScheduledJobFactsHelperGen(OCIResourceFactsHelperBase):
...
OsManagementHubScheduledJobFactsHelperCustom = get_custom_class(
    "OsManagementHubScheduledJobFactsHelperCustom"
)


class ResourceFactsHelper(
    OsManagementHubScheduledJobFactsHelperCustom,
    OsManagementHubScheduledJobFactsHelperGen,
):
    pass
