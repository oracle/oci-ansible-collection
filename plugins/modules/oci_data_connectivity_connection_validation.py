                                                            ...
                                                            parameter_type:
                                                                ...
                                                                suboptions:
                                                                    ...
                                                                    config_definition:
                                                                        description:
                                                                            - ""
                                                                            - Applicable when model_type is one of ['DATA_TYPE', 'CONFIGURED_TYPE',
                                                                              'COMPOSITE_TYPE']
                                                                        type: dict
                                                                        suboptions:
                                                                            key:
                                ...
                                suboptions:
                                    ...
                                    primary_schema:
                                        ...
                                        suboptions:
                                            ...
                                            resource_name:
                                                description:
                                                    - A resource name can have letters, numbers, and special characters. The value is editable and is restricted
                                                      to 4000 characters.
                                                    - Applicable when model_type is 'PRIVATE_END_POINT'
                                                type: str
                                            description:
...
EXAMPLES = """
- name: Create connection_validation
      ...
      - # required
        ...
        - # required
          ...
          - # required
            ...
            object_status: 56
            identifier: identifier_example
            data_assets: [ "data_assets_example" ]
    connection:
      # required
      name: name_example
      identifier: identifier_example
...
connection_validation:
    description:
        - Details of the ConnectionValidation resource acted upon by the current operation
    returned: on success
    type: complex
    contains:
        validation_message:
                                    ...
                                    contains:
                                        ...
                                        primary_schema:
                                            ...
                                            contains:
                                                ...
                                                resource_name:
                                                    description:
                                                        - A resource name can have letters, numbers, and special characters. The value is editable and is
                                                          restricted to 4000 characters.
                                                    returned: on success
                                                    type: str
                                                    sample: resource_name_example
                                                description:
...
try:
    ...
    from oci.data_connectivity.models import CreateConnectionValidationDetails
...
class ConnectionValidationHelperGen(OCIResourceHelperBase):
    ...
    def get_possible_entity_types(self):
        return super(
            ConnectionValidationHelperGen, self
        ).get_possible_entity_types() + [
            "connectionvalidation",
            "connectionvalidations",
            "dataConnectivityconnectionvalidation",
            "dataConnectivityconnectionvalidations",
            "connectionvalidationresource",
            "connectionvalidationsresource",
            "dataconnectivity",
        ]
    ...
    def create_resource(self):
        ...
        return oci_wait_utils.call_and_wait(
            call_fn=self.client.create_connection_validation,
            call_fn_args=(),
            call_fn_kwargs=dict(
                registry_id=self.module.params.get("registry_id"),
                create_connection_validation_details=create_details,
...
class ResourceHelper(ConnectionValidationHelperCustom, ConnectionValidationHelperGen):
    pass
...
def main():
                                        ...
                                        options=dict(
                                            ...
                                            primary_schema=dict(
                                                ...
                                                options=dict(
                                                    ...
                                                    metadata=dict(
                                                        ...
                                                        options=dict(
                                                            created_by=dict(type="str"),
                                                            created_by_name=dict(
                                                                type="str"
                                                            ),
                                                            updated_by=dict(type="str"),
                                                            updated_by_name=dict(
                                                                type="str"
                                                            ),
                                                            time_created=dict(
                                                                type="str"
                                                            ...
                                                            identifier_path=dict(
                                                                type="str"
                                                            ),
                                                            info_fields=dict(
                                                                type="dict"
                                                            ),
                                                            registry_version=dict(
                                                                type="int"
                                                            ),
                                                            labels=dict(
                                                                type="list",
                                            ...
                                            registry_metadata=dict(
                                                ...
                                                options=dict(
                                                    ...
                                                    is_favorite=dict(type="bool"),
                                                    created_by_user_id=dict(type="str"),
                                                    created_by_user_name=dict(
                                                        type="str"
                                                    ),
                                                    updated_by_user_id=dict(type="str"),
                                                    updated_by_user_name=dict(
                                                        type="str"
                                                    ),
                                                    time_created=dict(type="str"),
                                                    time_updated=dict(type="str"),
    ...
    resource_helper = ResourceHelper(
        module=module,
        resource_type="connection_validation",
